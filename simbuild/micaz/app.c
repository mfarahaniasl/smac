...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0x7ff70d2be400, const void *arg_0x7ff70d2be700);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0x7ff70d236190) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x7ff70cfdd3a0), 
int (*key_eq_fn)(void *arg_0x7ff70cfddb70, void *arg_0x7ff70cfdde30));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x7ff70cdc9660, int arg_0x7ff70cdc98e0);
static double RandomUniform(void );
# 43 "/opt/tinyos-2_1_2/tos/lib/tossim/sim_noise.c"
int numCase1 = 0;
int numCase2 = 0;
int numTotal = 0;
...
} __attribute__((packed)) SYN_packet_t;
...
} __attribute__((packed)) RTS_packet_t;
...
typedef nx_struct CTS_packet {
  ...
  nx_int16_t dest_id;
  nx_uint16_t duration;
} __attribute__((packed)) CTS_packet_t;
...
typedef nx_struct FRTS_packet {
  ...
  nx_int16_t dest_id;
  nx_uint16_t duration;
} __attribute__((packed)) FRTS_packet_t;
...
typedef nx_struct preamble_packet {
  ...
  nx_uint16_t dest_id;
  nx_uint8_t seq_no;
} __attribute__((packed)) preamble_packet_t;
...
# 15 "/home/mehrkavir-lap1/tWorkspace/smac-1.0/src/smac.h"
enum __nesc_unnamed4327 {
  ...
  LEACH_ROUND_LENGTH = 100000, 
  LEACH_ANNONCE_LENGTH = 10000, 
  LEACH_ORGANISATION_LENGTH = 40000, 
  LEACH_SLOT_LENGTH = 1000, 
...
typedef nx_struct annonce_msg {
  nx_uint8_t ID_MEMBER;
  nx_uint8_t state;
  nx_uint8_t type;
} __attribute__((packed)) annonce_msg_t;
...
typedef nx_struct admission_msg {
  nx_uint8_t ID_MEMBER;
} __attribute__((packed)) admission_msg_t;
...
typedef nx_struct aggregate_msg {
  nx_uint8_t data;
} __attribute__((packed)) aggregate_msg_t;
...
typedef TMilli MAC_SMAC$gotrts_sleepTimer$precision_tag;
typedef TMilli MAC_SMAC$sleepTimer$precision_tag;
typedef TMilli MAC_SMAC$SYNwaitTimer$precision_tag;
typedef TMilli MAC_SMAC$activeTimer$precision_tag;
typedef TMilli MAC_SMAC$RTSwaitTimer$precision_tag;
typedef TMilli MAC_SMAC$CTSwaitTimer$precision_tag;
...
enum AMQueueP$__nesc_unnamed4329 {
  AMQueueP$NUM_CLIENTS = 5U
};
typedef TMilli SmacC$NewCycle$precision_tag;
typedef TMilli SmacC$Appearance$precision_tag;
typedef TMilli SmacC$Aggregate$precision_tag;
typedef TMilli SmacC$Annonce$precision_tag;
typedef TMilli SmacC$SendData$precision_tag;
...
uint8_t len);
# 45 "/opt/tinyos-2_1_2/tos/lib/tossim/TossimPacket.nc"
static int8_t TossimActiveMessageC$TossimPacket$strength(message_t *msg);
# 78 "/opt/tinyos-2_1_2/tos/interfaces/Receive.nc"
static 
#line 74
message_t * 
...
# 88 "/opt/tinyos-2_1_2/tos/interfaces/AMPacket.nc"
...
static void MAC_SMAC$gotrts_sleepTimer$fired(void );
#line 83
static void MAC_SMAC$sleepTimer$fired(void );
# 75 "/opt/tinyos-2_1_2/tos/interfaces/TaskBasic.nc"
static void MAC_SMAC$stopDoneTask$runTask(void );
# 57 "/opt/tinyos-2_1_2/tos/lib/tossim/TossimPacketModel.nc"
static error_t MAC_SMAC$Packet$send(int node, message_t *msg, uint8_t len);
# 4 "/home/mehrkavir-lap1/tWorkspace/smac-1.0/src/iSMAC.nc"
static void MAC_SMAC$iSMAC$setSynchronizer(uint8_t status);
#line 2
static error_t MAC_SMAC$iSMAC$keepAlive(uint8_t status);


static void MAC_SMAC$iSMAC$setFollower(uint8_t status);
# 75 "/opt/tinyos-2_1_2/tos/interfaces/TaskBasic.nc"
static void MAC_SMAC$sendDoneTask$runTask(void );
# 62 "/opt/tinyos-2_1_2/tos/interfaces/Init.nc"
static error_t MAC_SMAC$Init$init(void );
# 75 "/opt/tinyos-2_1_2/tos/interfaces/TaskBasic.nc"
static void MAC_SMAC$startDoneTask$runTask(void );
# 104 "/opt/tinyos-2_1_2/tos/interfaces/SplitControl.nc"
static error_t MAC_SMAC$Control$start(void );
#line 130
static error_t MAC_SMAC$Control$stop(void );
# 60 "/opt/tinyos-2_1_2/tos/lib/tossim/GainRadioModel.nc"
static void MAC_SMAC$GainRadioModel$receive(message_t *msg);
#line 59
static void MAC_SMAC$GainRadioModel$acked(message_t *msg);

static bool MAC_SMAC$GainRadioModel$shouldAck(message_t *msg);
# 83 "/opt/tinyos-2_1_2/tos/lib/timer/Timer.nc"
static void MAC_SMAC$SYNwaitTimer$fired(void );
#line 83
static void MAC_SMAC$activeTimer$fired(void );
#line 83
static void MAC_SMAC$RTSwaitTimer$fired(void );
#line 83
static void MAC_SMAC$CTSwaitTimer$fired(void );
# 110 "/opt/tinyos-2_1_2/tos/interfaces/AMSend.nc"
static void MAC_SMAC$MacAMSend$sendDone(
#line 103
message_t * msg, 
...
static void /*ActiveMessageC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(
#line 96
message_t * msg, 
...
# 83 "/opt/tinyos-2_1_2/tos/lib/timer/Timer.nc"
static void SmacC$NewCycle$fired(void );
#line 83
static void SmacC$Appearance$fired(void );
# 78 "/opt/tinyos-2_1_2/tos/interfaces/Receive.nc"
static 
#line 74
message_t * 
...
SmacC$Aggregate_ReceiveMsg$receive(
#line 71
message_t * msg, 
void * payload, 
...
static void SmacC$Boot$booted(void );
# 8 "/home/mehrkavir-lap1/tWorkspace/smac-1.0/src/iSMAC.nc"
static void SmacC$iSMAC$activationChanged(uint8_t status);
#line 6
static void SmacC$iSMAC$activated(void );


static void SmacC$iSMAC$syncReceived(uint16_t node_id);
# 113 "/opt/tinyos-2_1_2/tos/interfaces/SplitControl.nc"
static void SmacC$RadioControl$startDone(error_t error);
#line 138
static void SmacC$RadioControl$stopDone(error_t error);
# 78 "/opt/tinyos-2_1_2/tos/interfaces/Receive.nc"
static 
#line 74
message_t * 
...
SmacC$NewCycle_ReceiveMsg$receive(
#line 71
message_t * msg, 
void * payload, 
...
uint8_t len);
# 83 "/opt/tinyos-2_1_2/tos/lib/timer/Timer.nc"
static void SmacC$Aggregate$fired(void );
# 78 "/opt/tinyos-2_1_2/tos/interfaces/Receive.nc"
static 
#line 74
message_t * 
...
SmacC$Annonce_ReceiveMsg$receive(
#line 71
message_t * msg, 
void * payload, 
...
uint8_t len);
# 110 "/opt/tinyos-2_1_2/tos/interfaces/AMSend.nc"
static void SmacC$Annonce_SendMsg$sendDone(
#line 103
message_t * msg, 
...
error_t error);
#line 110
static void SmacC$Data_SendMsg$sendDone(
#line 103
message_t * msg, 
...
uint8_t len);
# 110 "/opt/tinyos-2_1_2/tos/interfaces/AMSend.nc"
static void SmacC$NewCycle_SendMsg$sendDone(
#line 103
message_t * msg, 
...
error_t error);
#line 110
static void SmacC$Aggregate_SendMsg$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 83 "/opt/tinyos-2_1_2/tos/lib/timer/Timer.nc"
static void SmacC$Annonce$fired(void );
#line 83
static void SmacC$SendData$fired(void );
# 62 "/opt/tinyos-2_1_2/tos/interfaces/Init.nc"
static error_t LedsP$Init$init(void );
# 83 "/opt/tinyos-2_1_2/tos/interfaces/Leds.nc"
static void LedsP$Leds$led1Toggle(void );
# 52 "/opt/tinyos-2_1_2/tos/interfaces/Random.nc"
...
# 80 "/opt/tinyos-2_1_2/tos/interfaces/AMSend.nc"
static error_t /*SmacApp.Annonce_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$1$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 100 "/opt/tinyos-2_1_2/tos/interfaces/Send.nc"
static void /*SmacApp.Annonce_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$1$Send$sendDone(
#line 96
message_t * msg, 
...
error_t error);
# 80 "/opt/tinyos-2_1_2/tos/interfaces/AMSend.nc"
static error_t /*SmacApp.NewCycle_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$2$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 100 "/opt/tinyos-2_1_2/tos/interfaces/Send.nc"
static void /*SmacApp.NewCycle_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$2$Send$sendDone(
#line 96
message_t * msg, 
...
error_t error);
# 80 "/opt/tinyos-2_1_2/tos/interfaces/AMSend.nc"
static error_t /*SmacApp.DATA_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$3$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 100 "/opt/tinyos-2_1_2/tos/interfaces/Send.nc"
static void /*SmacApp.DATA_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$3$Send$sendDone(
#line 96
message_t * msg, 
...
error_t error);
# 80 "/opt/tinyos-2_1_2/tos/interfaces/AMSend.nc"
static error_t /*SmacApp.Aggregate_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$4$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 100 "/opt/tinyos-2_1_2/tos/interfaces/Send.nc"
static void /*SmacApp.Aggregate_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$4$Send$sendDone(
#line 96
message_t * msg, 
...
static inline tossim_metadata_t *TossimActiveMessageC$getMetadata(message_t *amsg);
...
uint8_t len);
#line 99
static inline int8_t TossimActiveMessageC$TossimPacket$strength(message_t *msg);
...
# 92 "/opt/tinyos-2_1_2/tos/lib/timer/Timer.nc"
static bool MAC_SMAC$gotrts_sleepTimer$isRunning(void );
#line 73
static void MAC_SMAC$gotrts_sleepTimer$startOneShot(uint32_t dt);
#line 136
static uint32_t MAC_SMAC$sleepTimer$getNow(void );
...
static uint32_t MAC_SMAC$sleepTimer$gett0(void );
#line 92
static bool MAC_SMAC$sleepTimer$isRunning(void );
#line 73
static void MAC_SMAC$sleepTimer$startOneShot(uint32_t dt);
# 67 "/opt/tinyos-2_1_2/tos/interfaces/TaskBasic.nc"
static error_t MAC_SMAC$stopDoneTask$postTask(void );
# 85 "/opt/tinyos-2_1_2/tos/lib/tossim/TossimPacketModel.nc"
static void MAC_SMAC$Packet$receive(message_t *msg);
#line 76
static void MAC_SMAC$Packet$sendDone(message_t *msg, error_t error);
...
static bool MAC_SMAC$Packet$shouldAck(message_t *msg);
# 8 "/home/mehrkavir-lap1/tWorkspace/smac-1.0/src/iSMAC.nc"
static void MAC_SMAC$iSMAC$activationChanged(uint8_t status);
#line 6
static void MAC_SMAC$iSMAC$activated(void );


static void MAC_SMAC$iSMAC$syncReceived(uint16_t node_id);
# 78 "/opt/tinyos-2_1_2/tos/interfaces/Packet.nc"
static uint8_t MAC_SMAC$ConPacket$payloadLength(
#line 74
message_t * msg);
#line 126
static 
...
uint8_t len);
#line 106
static uint8_t MAC_SMAC$ConPacket$maxPayloadLength(void );
# 67 "/opt/tinyos-2_1_2/tos/interfaces/TaskBasic.nc"
static error_t MAC_SMAC$startDoneTask$postTask(void );
# 113 "/opt/tinyos-2_1_2/tos/interfaces/SplitControl.nc"
static void MAC_SMAC$Control$startDone(error_t error);
#line 138
static void MAC_SMAC$Control$stopDone(error_t error);
# 48 "/opt/tinyos-2_1_2/tos/lib/tossim/GainRadioModel.nc"
static void MAC_SMAC$GainRadioModel$putOnAirTo(int dest, 
message_t *msg, 
bool ack, 
sim_time_t endTime, 
double gain, 
...
static bool MAC_SMAC$GainRadioModel$clearChannel(void );
static void MAC_SMAC$GainRadioModel$setPendingTransmission(void );
# 136 "/opt/tinyos-2_1_2/tos/lib/timer/Timer.nc"
static uint32_t MAC_SMAC$SYNwaitTimer$getNow(void );
...
static uint32_t MAC_SMAC$SYNwaitTimer$gett0(void );
#line 92
static bool MAC_SMAC$SYNwaitTimer$isRunning(void );
#line 73
static void MAC_SMAC$SYNwaitTimer$startOneShot(uint32_t dt);
#line 136
static uint32_t MAC_SMAC$activeTimer$getNow(void );
...
static uint32_t MAC_SMAC$activeTimer$gett0(void );
#line 92
static bool MAC_SMAC$activeTimer$isRunning(void );
#line 73
static void MAC_SMAC$activeTimer$startOneShot(uint32_t dt);
#line 73
static void MAC_SMAC$RTSwaitTimer$startOneShot(uint32_t dt);




static void MAC_SMAC$RTSwaitTimer$stop(void );
#line 73
static void MAC_SMAC$CTSwaitTimer$startOneShot(uint32_t dt);




static void MAC_SMAC$CTSwaitTimer$stop(void );
# 460 "/opt/tinyos-2_1_2/tos/lib/tossim/MAC_SMAC.nc"
enum MAC_SMAC$__nesc_unnamed4331 {
#line 460
  MAC_SMAC$startDoneTask = 0U
};
#line 460
typedef int MAC_SMAC$__nesc_sillytask_startDoneTask[MAC_SMAC$startDoneTask];
...
enum MAC_SMAC$__nesc_unnamed4332 {
#line 471
  MAC_SMAC$stopDoneTask = 1U
};
#line 471
typedef int MAC_SMAC$__nesc_sillytask_stopDoneTask[MAC_SMAC$stopDoneTask];
#line 537
enum MAC_SMAC$__nesc_unnamed4333 {
#line 537
  MAC_SMAC$sendDoneTask = 2U
};
#line 537
typedef int MAC_SMAC$__nesc_sillytask_sendDoneTask[MAC_SMAC$sendDoneTask];
#line 58
bool MAC_SMAC$initialized[1000];
bool MAC_SMAC$running[1000];
uint8_t MAC_SMAC$backoffCount[1000];
uint8_t MAC_SMAC$synbackoffCount[1000];
uint8_t MAC_SMAC$rtsbackoffCount[1000];
uint8_t MAC_SMAC$ctsbackoffCount[1000];
uint8_t MAC_SMAC$noRTSCount[1000];
uint8_t MAC_SMAC$totalRTSCount[1000];
uint8_t MAC_SMAC$noSYN_rec[1000];
uint8_t MAC_SMAC$no_SendTry[1000];

message_t *MAC_SMAC$sending[1000];
bool MAC_SMAC$transmitting[1000];
uint8_t MAC_SMAC$sendingLength[1000];
int MAC_SMAC$destNode[1000];
bool MAC_SMAC$radio_locked[1000];
bool MAC_SMAC$syn_done[1000];
bool MAC_SMAC$syn_sentbyme[1000];
bool MAC_SMAC$radioOnbyTimer[1000];
bool MAC_SMAC$imborderNode[1000];
bool MAC_SMAC$alreadyTryingforSYNC[1000];
bool MAC_SMAC$waiting_fordata[1000];



uint16_t MAC_SMAC$SLEEP_PERIOD[1000];
uint16_t MAC_SMAC$ACTIVE_PERIOD[1000];

SYN_packet_t *MAC_SMAC$syn[1000];

RTS_packet_t *MAC_SMAC$rts[1000];
CTS_packet_t *MAC_SMAC$cts[1000];
data_packet_t *MAC_SMAC$data_packet[1000];
data_packet_t *MAC_SMAC$data_packet2[1000];
data_packet_t *MAC_SMAC$data_rec2[1000];

uint8_t MAC_SMAC$syn_table[1000][4][3];
bool MAC_SMAC$isSynchroniser[1000];
bool MAC_SMAC$isFollower[1000];
message_t MAC_SMAC$synpacket[1000];
message_t MAC_SMAC$rtspacket[1000];
message_t MAC_SMAC$ctspacket[1000];


sim_event_t MAC_SMAC$sendEvent[1000];
sim_event_t MAC_SMAC$SYNsendEvent[1000];
sim_event_t MAC_SMAC$RTSsendEvent[1000];
sim_event_t MAC_SMAC$CTSsendEvent[1000];
sim_time_t MAC_SMAC$sample_time[1000];
sim_time_t MAC_SMAC$backoff2[1000];


static void MAC_SMAC$send_data(void );
static inline void MAC_SMAC$send_backoff(sim_event_t *evt);
static inline void MAC_SMAC$send_transmit(sim_event_t *evt);
static inline void MAC_SMAC$send_transmit_done(sim_event_t *evt);

static void MAC_SMAC$start_syn(void );
static inline void MAC_SMAC$send_syn(sim_event_t *evt);
static inline void MAC_SMAC$send_transmit_syn(sim_event_t *evt);
static inline void MAC_SMAC$send_transmit_done_syn(sim_event_t *evt);

static void MAC_SMAC$start_rts(void );
static void MAC_SMAC$send_rts(sim_event_t *evt);
static inline void MAC_SMAC$send_transmit_rts(sim_event_t *evt);
static inline void MAC_SMAC$send_transmit_done_rts(sim_event_t *evt);

static inline void MAC_SMAC$send_cts(sim_event_t *evt);
static inline void MAC_SMAC$send_transmit_cts(sim_event_t *evt);
static inline void MAC_SMAC$send_transmit_done_cts(sim_event_t *evt);


static inline tossim_metadata_t *MAC_SMAC$getMetadata(message_t *msg);



static inline tossim_header_t *MAC_SMAC$getHeaderdata(message_t *msg);



static inline int MAC_SMAC$sim_packet_header_length(void );



static inline error_t MAC_SMAC$Init$init(void );
#line 158
static inline error_t MAC_SMAC$iSMAC$keepAlive(uint8_t status);



static inline void MAC_SMAC$iSMAC$setSynchronizer(uint8_t status);



static inline void MAC_SMAC$iSMAC$setFollower(uint8_t status);




static inline void MAC_SMAC$activeTimer$fired(void );
#line 200
static inline void MAC_SMAC$sleepTimer$fired(void );
#line 234
static void MAC_SMAC$start_syn(void );
#line 287
static inline void MAC_SMAC$send_syn(sim_event_t *evt);
...
static inline void MAC_SMAC$gotrts_sleepTimer$fired(void );
#line 402
static inline void MAC_SMAC$SYNwaitTimer$fired(void );




static inline void MAC_SMAC$CTSwaitTimer$fired(void );





static inline void MAC_SMAC$RTSwaitTimer$fired(void );
#line 460
static inline void MAC_SMAC$startDoneTask$runTask(void );
...
static inline void MAC_SMAC$stopDoneTask$runTask(void );
...
static error_t MAC_SMAC$Control$stop(void );
#line 515
static inline void MAC_SMAC$MacAMSend$sendDone(message_t *msg, error_t error);
#line 537
static inline void MAC_SMAC$sendDoneTask$runTask(void );
#line 558
tossim_metadata_t *MAC_SMAC$metadata2[1000];
sim_time_t MAC_SMAC$duration2[1000];
RTS_packet_t *MAC_SMAC$rts[1000];


static inline error_t MAC_SMAC$Packet$send(int dest, message_t *msg, uint8_t len);
#line 656
static void MAC_SMAC$start_rts(void );
#line 700
static void MAC_SMAC$send_rts(sim_event_t *evt);
...
static inline void MAC_SMAC$send_transmit_done(sim_event_t *evt);
#line 1093
RTS_packet_t *MAC_SMAC$syn3[1000];
SYN_packet_t *MAC_SMAC$syn_rec[1000];
RTS_packet_t *MAC_SMAC$rts_rec[1000];
CTS_packet_t *MAC_SMAC$cts_rec[1000];
data_packet_t *MAC_SMAC$data_rec[1000];

static bool MAC_SMAC$borderNode_process(void );
#line 1139
static inline void MAC_SMAC$GainRadioModel$receive(message_t *msg);
#line 1319
uint8_t MAC_SMAC$error[1000];


static inline void MAC_SMAC$GainRadioModel$acked(message_t *msg);
...
# 110 "/opt/tinyos-2_1_2/tos/interfaces/AMSend.nc"
static void /*ActiveMessageC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(
#line 103
message_t * msg, 
...
static inline void /*ActiveMessageC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(message_t *m, error_t err);
# 80 "/opt/tinyos-2_1_2/tos/interfaces/AMSend.nc"
...
/*AMQueueP.AMQueueImplP*/AMQueueImplP$0$queue_entry_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$queue[1000][5];
uint8_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$cancelMask[1000][5 / 8 + 1];
...
static void CpmModelC$Model$putOnAirTo(int dest, message_t *msg, bool ack, sim_time_t endTime, double power, double reversePower);
#line 459
static void CpmModelC$Model$setPendingTransmission(void );
...
# 92 "/opt/tinyos-2_1_2/tos/lib/timer/Timer.nc"
static bool SmacC$Appearance$isRunning(void );
#line 73
static void SmacC$Appearance$startOneShot(uint32_t dt);




static void SmacC$Appearance$stop(void );
# 45 "/opt/tinyos-2_1_2/tos/lib/tossim/TossimPacket.nc"
static int8_t SmacC$TossimPacket$strength(message_t *msg);
# 4 "/home/mehrkavir-lap1/tWorkspace/smac-1.0/src/iSMAC.nc"
static void SmacC$iSMAC$setSynchronizer(uint8_t status);
#line 2
static error_t SmacC$iSMAC$keepAlive(uint8_t status);


static void SmacC$iSMAC$setFollower(uint8_t status);
...
uint8_t len);
# 52 "/opt/tinyos-2_1_2/tos/interfaces/Random.nc"
static uint16_t SmacC$Random$rand16(void );
# 80 "/opt/tinyos-2_1_2/tos/interfaces/AMSend.nc"
static error_t SmacC$Annonce_SendMsg$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 83 "/opt/tinyos-2_1_2/tos/interfaces/Leds.nc"
static void SmacC$Leds$led1Toggle(void );
# 80 "/opt/tinyos-2_1_2/tos/interfaces/AMSend.nc"
static error_t SmacC$Data_SendMsg$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
#line 80
static error_t SmacC$NewCycle_SendMsg$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 88 "/opt/tinyos-2_1_2/tos/interfaces/AMPacket.nc"
static am_addr_t SmacC$AMPacket$source(
#line 84
message_t * amsg);
# 80 "/opt/tinyos-2_1_2/tos/interfaces/AMSend.nc"
static error_t SmacC$Aggregate_SendMsg$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 33 "/home/mehrkavir-lap1/tWorkspace/smac-1.0/src/SmacC.nc"
message_t SmacC$packet[1000];
uint16_t SmacC$_timeTick[1000];
uint16_t SmacC$_timeTick_annonce[1000];
uint16_t SmacC$_timeTick_newCycle[1000];
uint16_t SmacC$_timeTick_aggregate[1000];
uint16_t SmacC$_timeTick_data[1000];
bool SmacC$radio_locked[1000];
bool SmacC$isAppearance[1000];
bool SmacC$seeBaseStation[1000];
bool SmacC$hasCH[1000];
uint8_t SmacC$myState[1000];
uint16_t SmacC$myCH_ID[1000];
...
uint8_t SmacC$memberCount_received[1000];

uint16_t SmacC$aggregate_val[1000];
bool SmacC$macIsActive[1000];
...
static inline void SmacC$Boot$booted(void );
#line 89
static inline void SmacC$RadioControl$startDone(error_t err);
...
static inline void SmacC$RadioControl$stopDone(error_t err);





static inline void SmacC$iSMAC$activationChanged(uint8_t status);
#line 149
static inline void SmacC$iSMAC$activated(void );
...
static inline void SmacC$iSMAC$syncReceived(uint16_t node_id);
#line 176
static inline void SmacC$Annonce$fired(void );
#line 201
static inline void SmacC$Appearance$fired(void );
...
static inline void SmacC$NewCycle$fired(void );
#line 235
static inline void SmacC$SendData$fired(void );
#line 254
static inline void SmacC$Aggregate$fired(void );
#line 282
static inline void SmacC$Annonce_SendMsg$sendDone(message_t *msg, error_t error);




static inline message_t *SmacC$Annonce_ReceiveMsg$receive(message_t *msg, 
void *payload, uint8_t len);
#line 327
static inline void SmacC$NewCycle_SendMsg$sendDone(message_t *msg, error_t error);



static inline message_t *SmacC$NewCycle_ReceiveMsg$receive(message_t *msg, 
void *payload, uint8_t len);
#line 355
static inline void SmacC$Data_SendMsg$sendDone(message_t *msg, error_t error);



static inline message_t *SmacC$Data_ReceiveMsg$receive(message_t *msg, 
void *payload, uint8_t len);
#line 378
static inline void SmacC$Aggregate_SendMsg$sendDone(message_t *msg, error_t error);



static inline message_t *SmacC$Aggregate_ReceiveMsg$receive(message_t *msg, 
void *payload, uint8_t len);
# 46 "/opt/tinyos-2_1_2/tos/interfaces/GeneralIO.nc"
...
# 52 "/opt/tinyos-2_1_2/tos/system/RandomMlcgC.nc"
...
# 110 "/opt/tinyos-2_1_2/tos/interfaces/AMSend.nc"
static void /*SmacApp.Annonce_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$1$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/tinyos-2_1_2/tos/interfaces/Send.nc"
static error_t /*SmacApp.Annonce_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$1$Send$send(
#line 67
message_t * msg, 
...
static void /*SmacApp.Annonce_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$1$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*SmacApp.Annonce_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$1$AMPacket$setType(
#line 158
message_t * amsg, 
...
static inline error_t /*SmacApp.Annonce_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$1$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*SmacApp.Annonce_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$1$Send$sendDone(message_t *m, error_t err);
# 110 "/opt/tinyos-2_1_2/tos/interfaces/AMSend.nc"
static void /*SmacApp.NewCycle_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$2$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/tinyos-2_1_2/tos/interfaces/Send.nc"
static error_t /*SmacApp.NewCycle_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$2$Send$send(
#line 67
message_t * msg, 
...
uint8_t len);
# 103 "/opt/tinyos-2_1_2/tos/interfaces/AMPacket.nc"
static void /*SmacApp.NewCycle_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$2$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*SmacApp.NewCycle_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$2$AMPacket$setType(
#line 158
message_t * amsg, 
...
am_id_t t);
# 53 "/opt/tinyos-2_1_2/tos/system/AMQueueEntryP.nc"
static inline error_t /*SmacApp.NewCycle_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$2$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*SmacApp.NewCycle_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$2$Send$sendDone(message_t *m, error_t err);
# 110 "/opt/tinyos-2_1_2/tos/interfaces/AMSend.nc"
static void /*SmacApp.DATA_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$3$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/tinyos-2_1_2/tos/interfaces/Send.nc"
static error_t /*SmacApp.DATA_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$3$Send$send(
#line 67
message_t * msg, 
...
uint8_t len);
# 103 "/opt/tinyos-2_1_2/tos/interfaces/AMPacket.nc"
static void /*SmacApp.DATA_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$3$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*SmacApp.DATA_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$3$AMPacket$setType(
#line 158
message_t * amsg, 
...
am_id_t t);
# 53 "/opt/tinyos-2_1_2/tos/system/AMQueueEntryP.nc"
static inline error_t /*SmacApp.DATA_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$3$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*SmacApp.DATA_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$3$Send$sendDone(message_t *m, error_t err);
# 110 "/opt/tinyos-2_1_2/tos/interfaces/AMSend.nc"
static void /*SmacApp.Aggregate_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$4$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/tinyos-2_1_2/tos/interfaces/Send.nc"
static error_t /*SmacApp.Aggregate_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$4$Send$send(
#line 67
message_t * msg, 
...
uint8_t len);
# 103 "/opt/tinyos-2_1_2/tos/interfaces/AMPacket.nc"
static void /*SmacApp.Aggregate_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$4$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*SmacApp.Aggregate_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$4$AMPacket$setType(
#line 158
message_t * amsg, 
...
am_id_t t);
# 53 "/opt/tinyos-2_1_2/tos/system/AMQueueEntryP.nc"
static inline error_t /*SmacApp.Aggregate_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$4$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*SmacApp.Aggregate_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$4$Send$sendDone(message_t *m, error_t err);
...
# 122 "/opt/tinyos-2_1_2/tos/lib/tossim/sim_noise.c"
inline static unsigned int sim_noise_hash(void *key)
#line 122
{
  char *pt = (char *)key;
...
# 276 "/opt/tinyos-2_1_2/tos/lib/tossim/sim_noise.c"
static inline void sim_noise_alarm()
#line 276
{
  dummy = 5;
...
# 166 "/opt/tinyos-2_1_2/tos/lib/tossim/MAC_SMAC.nc"
static inline void MAC_SMAC$iSMAC$setFollower(uint8_t status)
#line 166
{
}

# 5 "/home/mehrkavir-lap1/tWorkspace/smac-1.0/src/iSMAC.nc"
inline static void SmacC$iSMAC$setFollower(uint8_t status){
#line 5
  MAC_SMAC$iSMAC$setFollower(status);
#line 5
}
#line 5
# 162 "/opt/tinyos-2_1_2/tos/lib/tossim/MAC_SMAC.nc"
static inline void MAC_SMAC$iSMAC$setSynchronizer(uint8_t status)
#line 162
{
}
...
# 4 "/home/mehrkavir-lap1/tWorkspace/smac-1.0/src/iSMAC.nc"
inline static void SmacC$iSMAC$setSynchronizer(uint8_t status){
#line 4
  MAC_SMAC$iSMAC$setSynchronizer(status);
#line 4
}
#line 4
# 158 "/opt/tinyos-2_1_2/tos/lib/tossim/MAC_SMAC.nc"
static inline error_t MAC_SMAC$iSMAC$keepAlive(uint8_t status)
#line 158
{
}

# 2 "/home/mehrkavir-lap1/tWorkspace/smac-1.0/src/iSMAC.nc"
inline static error_t SmacC$iSMAC$keepAlive(uint8_t status){
#line 2
  unsigned char __nesc_result;
#line 2

#line 2
  __nesc_result = MAC_SMAC$iSMAC$keepAlive(status);
#line 2
...
#line 2
# 164 "/opt/tinyos-2_1_2/tos/lib/timer/VirtualizeTimerC.nc"
static inline void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$stop(uint8_t num)
{
...
inline static void SmacC$Appearance$stop(void ){
#line 78
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$stop(7U);
#line 78
}
#line 78
# 169 "/opt/tinyos-2_1_2/tos/lib/timer/VirtualizeTimerC.nc"
static inline bool /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$isRunning(uint8_t num)
{
...
# 92 "/opt/tinyos-2_1_2/tos/lib/timer/Timer.nc"
inline static bool SmacC$Appearance$isRunning(void ){
#line 92
  unsigned char __nesc_result;
#line 92

#line 92
  __nesc_result = /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$isRunning(7U);
#line 92
...
# 69 "/opt/tinyos-2_1_2/tos/lib/tossim/TossimActiveMessageC.nc"
static inline tossim_metadata_t *TossimActiveMessageC$getMetadata(message_t *amsg)
#line 69
{
...
#line 99
{
  return __nesc_ntoh_int8(TossimActiveMessageC$getMetadata(msg)->strength.nxdata);
}

# 45 "/opt/tinyos-2_1_2/tos/lib/tossim/TossimPacket.nc"
inline static int8_t SmacC$TossimPacket$strength(message_t *msg){
#line 45
  signed char __nesc_result;
#line 45

#line 45
  __nesc_result = TossimActiveMessageC$TossimPacket$strength(msg);
#line 45
...
#line 45
# 88 "/opt/tinyos-2_1_2/tos/interfaces/AMPacket.nc"
inline static am_addr_t SmacC$AMPacket$source(message_t * amsg){
#line 88
  unsigned short __nesc_result;
#line 88
...
#line 43
# 62 "/opt/tinyos-2_1_2/tos/chips/atm128/pins/sim/HplAtm128GeneralIOPinP.nc"
static __inline void /*HplAtm128GeneralIOC.PortA.Bit1*/HplAtm128GeneralIOPinP$1$IO$toggle(void )
#line 62
{
...
# 42 "/opt/tinyos-2_1_2/tos/interfaces/GeneralIO.nc"
...
#line 42
# 99 "/opt/tinyos-2_1_2/tos/system/LedsP.nc"
static inline void LedsP$Leds$led1Toggle(void )
#line 99
{
  LedsP$Led1$toggle();
  sim_log_debug(293U, "LedsC", "LEDS: Led""1"" %s.\n", LedsP$Led1$get() ? "off" : "on");
#line 101
  ;
}

# 83 "/opt/tinyos-2_1_2/tos/interfaces/Leds.nc"
inline static void SmacC$Leds$led1Toggle(void ){
#line 83
  LedsP$Leds$led1Toggle();
#line 83
}
#line 83
# 287 "/home/mehrkavir-lap1/tWorkspace/smac-1.0/src/SmacC.nc"
static inline message_t *SmacC$Annonce_ReceiveMsg$receive(message_t *msg, 
void *payload, uint8_t len)
#line 288
{
  SmacC$Leds$led1Toggle();

  if (len != sizeof(annonce_msg_t )) {
#line 291
      return msg;
    }
  else 
#line 292
    {
      ...
      uint8_t source_ID = SmacC$AMPacket$source(msg);
      int8_t strength = SmacC$TossimPacket$strength(msg);
      uint8_t rState = __nesc_ntoh_uint8(rsm->state.nxdata);

      sim_log_debug(277U, "RecivedPacket", "\t;%s \t;%i \t;%i \t;%i \t;Recieve New Packet.\n", sim_time_string(), TOS_NODE_ID, source_ID, strength);

      if (__nesc_ntoh_uint8(rsm->type.nxdata) == 1) {
          if (rState == 3 && !SmacC$seeBaseStation[sim_node()] && !SmacC$isAppearance[sim_node()]) {
              SmacC$seeBaseStation[sim_node()] = TRUE;
              sim_log_debug(278U, "DebugApp", "\t I see BaseStation. \t@%s\n", sim_time_string());
              sim_log_debug(279U, "DebugApp", "\t BaseStation link strong is %i. \t@%s\n", strength, sim_time_string());
              sim_log_debug(280U, "DebugGraph", ";%i;%i;CH;1 \n", TOS_NODE_ID, BASE_STATION_ADDRESS);

              if (!SmacC$isAppearance[sim_node()]) {
                  if (SmacC$Appearance$isRunning()) {
                    SmacC$Appearance$stop();
                    }
                  SmacC$isAppearance[sim_node()] = TRUE;

                  SmacC$iSMAC$keepAlive(0);
                  SmacC$iSMAC$setSynchronizer(1);
                  SmacC$iSMAC$setFollower(0);

                  SmacC$myState[sim_node()] = 2;
                  SmacC$_timeTick_newCycle[sim_node()] = SmacC$_timeTick[sim_node()] + 100;
                }
            }
        }
...
#line 336
    {
      ...
      int8_t strength = SmacC$TossimPacket$strength(msg);
      uint8_t source_ID = SmacC$AMPacket$source(msg);
      uint8_t rMember = __nesc_ntoh_uint8(rsm->ID_MEMBER.nxdata);
      uint8_t rState = __nesc_ntoh_uint8(rsm->state.nxdata);

      sim_log_debug(281U, "RecivedPacket", "\t;%s \t;%i \t;%i \t;%i \t;Recieve New Packet.\n", sim_time_string(), TOS_NODE_ID, source_ID, strength);

      if (source_ID != SmacC$myCH_ID[sim_node()]) {
        return msg;
        }
      sim_log_debug(282U, "DebugApp", "\t Received new cycle trig from my CH(%i). \t@%s\n", source_ID, sim_time_string());

      SmacC$_timeTick_data[sim_node()] = SmacC$_timeTick[sim_node()] + 1;
      return msg;
    }
}
...
#line 362
    {
      ...
      int8_t strength = SmacC$TossimPacket$strength(msg);
      uint8_t source_ID = SmacC$AMPacket$source(msg);
      uint8_t rData = __nesc_ntoh_uint8(rsm->data.nxdata);

      sim_log_debug(283U, "RecivedPacket", "\t;%s \t;%i \t;%i \t;%i \t;Recieve New Packet. \n", sim_time_string(), TOS_NODE_ID, source_ID, strength);
      sim_log_debug(284U, "DebugApp", "\t Received new data from %i. \t@%s\n", source_ID, sim_time_string());

      SmacC$aggregate_val[sim_node()] += rData;
      SmacC$memberCount_received[sim_node()]++;
...
#line 385
    {
      ...
      sim_log_debug(285U, "RecivedPacket", "\t;%s \t;%i \t;%i \t;%i \t;Recieve New Packet.\n", sim_time_string(), TOS_NODE_ID, source_ID, strength);
      sim_log_debug(286U, "DebugApp", "\t Received aggregated value from %i = %i . \t@%s\n", source_ID, rData, sim_time_string());
...
# 78 "/opt/tinyos-2_1_2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0x7ff70c986e30, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x7ff70c986e30) {
#line 78
    case 200:
#line 78
      __nesc_result = SmacC$Annonce_ReceiveMsg$receive(msg, payload, len);
#line 78
      break;
#line 78
    case 203:
#line 78
      __nesc_result = SmacC$NewCycle_ReceiveMsg$receive(msg, payload, len);
#line 78
      break;
#line 78
    case 204:
#line 78
      __nesc_result = SmacC$Data_ReceiveMsg$receive(msg, payload, len);
#line 78
      break;
#line 78
    case 205:
#line 78
      __nesc_result = SmacC$Aggregate_ReceiveMsg$receive(msg, payload, len);
#line 78
      break;
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0x7ff70c986e30, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/opt/tinyos-2_1_2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0x7ff70c985a50, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0x7ff70c985a50, msg, payload, len);
#line 78
...
# 89 "/home/mehrkavir-lap1/tWorkspace/smac-1.0/src/SmacC.nc"
static inline void SmacC$RadioControl$startDone(error_t err)
#line 89
{
  if (err == SUCCESS) {
      ...
      sim_log_debug(264U, "DebugApp", "\t Radio Start done. @%s\t\n", sim_time_string());
    }
}

# 113 "/opt/tinyos-2_1_2/tos/interfaces/SplitControl.nc"
inline static void MAC_SMAC$Control$startDone(error_t error){
#line 113
  SmacC$RadioControl$startDone(error);
#line 113
}
#line 113
# 460 "/opt/tinyos-2_1_2/tos/lib/tossim/MAC_SMAC.nc"
...
#line 460
{
  ...
  MAC_SMAC$Control$startDone(SUCCESS);
}

# 97 "/home/mehrkavir-lap1/tWorkspace/smac-1.0/src/SmacC.nc"
static inline void SmacC$RadioControl$stopDone(error_t err)
#line 97
{

  SmacC$macIsActive[sim_node()] = FALSE;
  sim_log_debug(265U, "DebugApp", "\t Radio Stop done. \t@%s\n", sim_time_string());
}

# 138 "/opt/tinyos-2_1_2/tos/interfaces/SplitControl.nc"
inline static void MAC_SMAC$Control$stopDone(error_t error){
#line 138
  SmacC$RadioControl$stopDone(error);
#line 138
}
#line 138
# 471 "/opt/tinyos-2_1_2/tos/lib/tossim/MAC_SMAC.nc"
static inline void MAC_SMAC$stopDoneTask$runTask(void )
#line 471
{
  MAC_SMAC$running[sim_node()] = FALSE;


  MAC_SMAC$Control$stopDone(SUCCESS);
}
...
# 110 "/opt/tinyos-2_1_2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0x7ff70c98ec70, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0x7ff70c98ec70, msg, error);
#line 110
}
#line 110
...
inline static void MAC_SMAC$Packet$sendDone(message_t *msg, error_t error){
#line 76
  TossimActiveMessageC$Model$sendDone(msg, error);
#line 76
}
#line 76
# 130 "/opt/tinyos-2_1_2/tos/lib/tossim/MAC_SMAC.nc"
static inline tossim_metadata_t *MAC_SMAC$getMetadata(message_t *msg)
#line 130
{
...
#line 537
{
  message_t *msg = MAC_SMAC$sending[sim_node()];
  tossim_metadata_t *meta = MAC_SMAC$getMetadata(msg);

#line 540
  __nesc_hton_uint8(meta->ack.nxdata, 0);
  __nesc_hton_int8(meta->strength.nxdata, 0);
  __nesc_hton_uint16(meta->time.nxdata, 0);
  MAC_SMAC$sending[sim_node()] = FALSE;
  ...
  MAC_SMAC$Packet$sendDone(msg, MAC_SMAC$running[sim_node()] ? SUCCESS : EOFF);
}
...
# 75 "/opt/tinyos-2_1_2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0x7ff70cc979c0){
#line 75
  switch (arg_0x7ff70cc979c0) {
#line 75
    case MAC_SMAC$startDoneTask:
#line 75
      MAC_SMAC$startDoneTask$runTask();
#line 75
      break;
#line 75
    case MAC_SMAC$stopDoneTask:
#line 75
      MAC_SMAC$stopDoneTask$runTask();
#line 75
      break;
#line 75
    case MAC_SMAC$sendDoneTask:
#line 75
      MAC_SMAC$sendDoneTask$runTask();
#line 75
      break;
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0x7ff70cc979c0);
#line 75
      break;
#line 75
    }
...
#line 75
# 378 "/home/mehrkavir-lap1/tWorkspace/smac-1.0/src/SmacC.nc"
static inline void SmacC$Aggregate_SendMsg$sendDone(message_t *msg, error_t error)
#line 378
{
  if (&SmacC$packet[sim_node()] == msg) {
#line 379
      SmacC$radio_locked[sim_node()] = FALSE;
    }
}

# 110 "/opt/tinyos-2_1_2/tos/interfaces/AMSend.nc"
inline static void /*SmacApp.Aggregate_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$4$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  SmacC$Aggregate_SendMsg$sendDone(msg, error);
#line 110
}
#line 110
# 65 "/opt/tinyos-2_1_2/tos/system/AMQueueEntryP.nc"
...
#line 65
{
  /*SmacApp.Aggregate_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$4$AMSend$sendDone(m, err);
}

# 355 "/home/mehrkavir-lap1/tWorkspace/smac-1.0/src/SmacC.nc"
static inline void SmacC$Data_SendMsg$sendDone(message_t *msg, error_t error)
#line 355
{
  if (&SmacC$packet[sim_node()] == msg) {
...
# 110 "/opt/tinyos-2_1_2/tos/interfaces/AMSend.nc"
inline static void /*SmacApp.DATA_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$3$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  SmacC$Data_SendMsg$sendDone(msg, error);
#line 110
}
#line 110
# 65 "/opt/tinyos-2_1_2/tos/system/AMQueueEntryP.nc"
...
#line 65
{
  /*SmacApp.DATA_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$3$AMSend$sendDone(m, err);
}

# 327 "/home/mehrkavir-lap1/tWorkspace/smac-1.0/src/SmacC.nc"
static inline void SmacC$NewCycle_SendMsg$sendDone(message_t *msg, error_t error)
#line 327
{
  if (&SmacC$packet[sim_node()] == msg) {
...
# 110 "/opt/tinyos-2_1_2/tos/interfaces/AMSend.nc"
inline static void /*SmacApp.NewCycle_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$2$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  SmacC$NewCycle_SendMsg$sendDone(msg, error);
#line 110
}
#line 110
# 65 "/opt/tinyos-2_1_2/tos/system/AMQueueEntryP.nc"
...
#line 65
{
  /*SmacApp.NewCycle_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$2$AMSend$sendDone(m, err);
}

# 282 "/home/mehrkavir-lap1/tWorkspace/smac-1.0/src/SmacC.nc"
static inline void SmacC$Annonce_SendMsg$sendDone(message_t *msg, error_t error)
#line 282
{
  if (&SmacC$packet[sim_node()] == msg) {
...
# 110 "/opt/tinyos-2_1_2/tos/interfaces/AMSend.nc"
inline static void /*SmacApp.Annonce_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$1$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  SmacC$Annonce_SendMsg$sendDone(msg, error);
#line 110
}
#line 110
# 65 "/opt/tinyos-2_1_2/tos/system/AMQueueEntryP.nc"
...
#line 65
{
  /*SmacApp.Annonce_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$1$AMSend$sendDone(m, err);
}

# 515 "/opt/tinyos-2_1_2/tos/lib/tossim/MAC_SMAC.nc"
static inline void MAC_SMAC$MacAMSend$sendDone(message_t *msg, error_t error)
#line 515
{
}
...
# 110 "/opt/tinyos-2_1_2/tos/interfaces/AMSend.nc"
inline static void /*ActiveMessageC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  MAC_SMAC$MacAMSend$sendDone(msg, error);
#line 110
}
#line 110
# 65 "/opt/tinyos-2_1_2/tos/system/AMQueueEntryP.nc"
...
#line 65
{
  /*ActiveMessageC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(m, err);
}
...
#line 67
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$current[sim_node()] = (/*AMQueueP.AMQueueImplP*/AMQueueImplP$0$current[sim_node()] + 1) % 5;
  for (i = 0; i < 5; i++) {
  ...
  if (i >= 5) {
#line 78
    /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$current[sim_node()] = 5;
    }
}

# 147 "/opt/tinyos-2_1_2/tos/interfaces/AMPacket.nc"
...
#line 78
# 80 "/opt/tinyos-2_1_2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0x7ff70c3f74d0, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0x7ff70c3f74d0, addr, msg, len);
#line 80
...
# 126 "/opt/tinyos-2_1_2/tos/interfaces/Packet.nc"
inline static void * MAC_SMAC$ConPacket$getPayload(message_t * msg, uint8_t len){
#line 126
  void *__nesc_result;
#line 126
...
#line 126
# 185 "/opt/tinyos-2_1_2/tos/lib/tossim/TossimActiveMessageC.nc"
static inline uint8_t TossimActiveMessageC$Packet$maxPayloadLength(void )
#line 185
{
  return 28;
...
# 106 "/opt/tinyos-2_1_2/tos/interfaces/Packet.nc"
inline static uint8_t MAC_SMAC$ConPacket$maxPayloadLength(void ){
#line 106
  unsigned char __nesc_result;
#line 106
...
#line 106
# 563 "/opt/tinyos-2_1_2/tos/lib/tossim/MAC_SMAC.nc"
static inline error_t MAC_SMAC$Packet$send(int dest, message_t *msg, uint8_t len)
#line 563
{
  uint8_t dataLen;
  ...
  if (!MAC_SMAC$initialized[sim_node()]) {
      sim_log_error(154U, "TossimPacketModelC", "TossimPacketModelC: Send.send() called, but not initialized!\n");
      return EOFF;
    }
  dataLen = MAC_SMAC$ConPacket$payloadLength(msg);

  payload = (uint8_t *)MAC_SMAC$ConPacket$getPayload(msg, MAC_SMAC$ConPacket$maxPayloadLength());

  payload2 = (uint8_t *)malloc(16 * sizeof(uint8_t ));
  memcpy(payload2, payload, dataLen);
  sim_log_debug(155U, "TossimPacketModelC", "TossimPacketModelC: have to send a packet of type 0,\n");
  ...
  if (MAC_SMAC$sending[sim_node()] != (void *)0) {
  ...
  MAC_SMAC$data_packet[sim_node()] = (data_packet_t *)MAC_SMAC$ConPacket$getPayload(msg, sizeof(data_packet_t ));
  __nesc_hton_uint16(MAC_SMAC$data_packet[sim_node()]->packet_type.nxdata, 0);
  memcpy(MAC_SMAC$data_packet[sim_node()]->payload, payload2, dataLen);
  MAC_SMAC$sendingLength[sim_node()] = len;

  MAC_SMAC$sending[sim_node()] = msg;
  MAC_SMAC$destNode[sim_node()] = dest;
  MAC_SMAC$backoffCount[sim_node()] = 0;

  MAC_SMAC$data_packet2[sim_node()] = (data_packet_t *)MAC_SMAC$ConPacket$getPayload(MAC_SMAC$sending[sim_node()], sizeof(data_packet_t ));
  sim_log_debug(156U, "TossimPacketModelC", "TossimPacketModelC: sending says type = %hu, payload = %hu to destNode=%d\n", __nesc_ntoh_uint16(MAC_SMAC$data_packet2[sim_node()]->packet_type.nxdata), __nesc_ntoh_uint8(MAC_SMAC$data_packet2[sim_node()]->payload[1].nxdata), MAC_SMAC$destNode[sim_node()]);

  __nesc_hton_uint16(MAC_SMAC$data_packet2[sim_node()]->packet_type.nxdata, 0);



  if (MAC_SMAC$destNode[sim_node()] == AM_BROADCAST_ADDR) {
      sim_log_debug(157U, "TossimPacketModelC", "TossimPacketModelC: have to Broadcast a packet of type %hu  to node %d.\n", __nesc_ntoh_uint16(MAC_SMAC$data_packet[sim_node()]->packet_type.nxdata), MAC_SMAC$destNode[sim_node()]);

      sim_log_debug(158U, "TossimPacketModelC", "TossimPacketModelC: syn_done true\n");
      MAC_SMAC$send_data();
    }
  else 
#line 640
    {
      MAC_SMAC$totalRTSCount[sim_node()] = 0;
      MAC_SMAC$noRTSCount[sim_node()] = 0;
      MAC_SMAC$start_rts();
    }
...
#line 57
  __nesc_result = MAC_SMAC$Packet$send(node, msg, len);
#line 57
...
#line 57
# 48 "/opt/tinyos-2_1_2/tos/lib/tossim/GainRadioModel.nc"
inline static void MAC_SMAC$GainRadioModel$putOnAirTo(int dest, message_t *msg, bool ack, sim_time_t endTime, double gain, double reverseGain){
#line 48
...
#line 48
# 92 "/opt/tinyos-2_1_2/tos/lib/timer/Timer.nc"
inline static bool MAC_SMAC$sleepTimer$isRunning(void ){
#line 92
  unsigned char __nesc_result;
#line 92
...
#line 92
# 1057 "/opt/tinyos-2_1_2/tos/lib/tossim/MAC_SMAC.nc"
static inline void MAC_SMAC$send_transmit_done(sim_event_t *evt)
#line 1057
{
  message_t *rval = MAC_SMAC$sending[sim_node()];
  tossim_metadata_t *metadata = MAC_SMAC$getMetadata(MAC_SMAC$sending[sim_node()]);

#line 1060
  MAC_SMAC$no_SendTry[sim_node()]++;
  if (__nesc_ntoh_uint8(metadata->ack.nxdata) || MAC_SMAC$destNode[sim_node()] == AM_BROADCAST_ADDR) {
      sim_log_debug(179U, "TossimPacketModelC", "PACKET: Received ack at %llu.\n", sim_time());
      MAC_SMAC$Packet$sendDone(rval, MAC_SMAC$running[sim_node()] ? SUCCESS : EOFF);
    }
  else {
      if (MAC_SMAC$no_SendTry[sim_node()] < 2 && MAC_SMAC$sending[sim_node()] != (void *)0) {
          sim_log_debug(180U, "TossimPacketModelC", "PACKET: Didnot Received ack, sending again at %llu.\n", sim_time());
          MAC_SMAC$send_data();
        }
      else {
          sim_log_debug(181U, "TossimPacketModelC", "PACKET: Didnot Received ack twice, Signaling Failed at %llu.\n", sim_time());
          MAC_SMAC$Packet$sendDone(rval, EBUSY);
        }
    }

  if ((__nesc_ntoh_uint8(metadata->ack.nxdata) == 1 || MAC_SMAC$no_SendTry[sim_node()] >= 2) || MAC_SMAC$destNode[sim_node()] == AM_BROADCAST_ADDR) {
      MAC_SMAC$sending[sim_node()] = (void *)0;

      MAC_SMAC$transmitting[sim_node()] = FALSE;
      MAC_SMAC$radio_locked[sim_node()] = FALSE;
      sim_log_debug(182U, "TossimPacketModelC", "PACKET: Signaling send done at %llu.\n", sim_time());




      if (MAC_SMAC$sleepTimer$isRunning()) {
          sim_log_debug(183U, "TossimPacketModelC", "In send_transmit_done, Its My sleeping time, going to sleep time %llu\n", sim_time());
          MAC_SMAC$Control$stop();
        }
    }
}
...
#line 1020
{
  ...
  duration = 8 * (MAC_SMAC$sendingLength[sim_node()] + MAC_SMAC$sim_packet_header_length());
  ...
  evt->time += duration;
  evt->handle = MAC_SMAC$send_transmit_done;

  sim_log_debug(177U, "TossimPacketModelC", "PACKET: Broadcasting packet to everyone. time: %llu\n", sim_time());





  MAC_SMAC$GainRadioModel$putOnAirTo(MAC_SMAC$destNode[sim_node()], MAC_SMAC$sending[sim_node()], __nesc_ntoh_uint8(metadata->ack.nxdata), evt->time, 0.0, 0.0);
...
inline static void MAC_SMAC$GainRadioModel$setPendingTransmission(void ){
#line 57
...
#line 57
#line 56
inline static bool MAC_SMAC$GainRadioModel$clearChannel(void ){
#line 56
  unsigned char __nesc_result;
#line 56
...
#line 56
# 979 "/opt/tinyos-2_1_2/tos/lib/tossim/MAC_SMAC.nc"
static inline void MAC_SMAC$send_backoff(sim_event_t *evt)
#line 979
{
  MAC_SMAC$backoffCount[sim_node()]++;

  if (MAC_SMAC$sending[sim_node()] != (void *)0) {
    if (MAC_SMAC$GainRadioModel$clearChannel()) {
        sim_time_t delay;

        delay = sim_csma_rxtx_delay();
        delay *= sim_ticks_per_sec() / sim_csma_symbols_per_sec();
        evt->time += delay;
        MAC_SMAC$transmitting[sim_node()] = TRUE;

        MAC_SMAC$GainRadioModel$setPendingTransmission();
        evt->handle = MAC_SMAC$send_transmit;
        sim_queue_insert(evt);
      }
    else {

        if (MAC_SMAC$backoffCount[sim_node()] <= 20) {
            MAC_SMAC$backoff2[sim_node()] = sim_random();
            MAC_SMAC$backoff2[sim_node()] %= sim_csma_init_high() - sim_csma_init_low();
            MAC_SMAC$backoff2[sim_node()] += sim_csma_init_low();
            MAC_SMAC$backoff2[sim_node()] *= sim_ticks_per_sec() / sim_csma_symbols_per_sec();

            evt->time += MAC_SMAC$backoff2[sim_node()];
            sim_queue_insert(evt);
          }
        else {
            message_t *rval = MAC_SMAC$sending[sim_node()];
...
# 67 "/opt/tinyos-2_1_2/tos/interfaces/TaskBasic.nc"
inline static error_t MAC_SMAC$stopDoneTask$postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP$TaskBasic$postTask(MAC_SMAC$stopDoneTask);
#line 67
...
#line 61
  __nesc_result = MAC_SMAC$GainRadioModel$shouldAck(msg);
#line 61
...
# 85 "/opt/tinyos-2_1_2/tos/lib/tossim/TossimPacketModel.nc"
inline static void MAC_SMAC$Packet$receive(message_t *msg){
#line 85
...
#line 85
# 78 "/opt/tinyos-2_1_2/tos/lib/timer/Timer.nc"
inline static void MAC_SMAC$CTSwaitTimer$stop(void ){
#line 78
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$stop(2U);
#line 78
}
#line 78
# 134 "/opt/tinyos-2_1_2/tos/lib/tossim/MAC_SMAC.nc"
static inline tossim_header_t *MAC_SMAC$getHeaderdata(message_t *msg)
#line 134
{
...
# 73 "/opt/tinyos-2_1_2/tos/lib/timer/Timer.nc"
inline static void MAC_SMAC$gotrts_sleepTimer$startOneShot(uint32_t dt){
#line 73
...
inline static void MAC_SMAC$RTSwaitTimer$stop(void ){
#line 78
...
#line 78
#line 92
inline static bool MAC_SMAC$gotrts_sleepTimer$isRunning(void ){
#line 92
  unsigned char __nesc_result;
#line 92
...
#line 92
#line 73
inline static void MAC_SMAC$CTSwaitTimer$startOneShot(uint32_t dt){
#line 73
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$startOneShot(2U, dt);
#line 73
}
#line 73
# 947 "/opt/tinyos-2_1_2/tos/lib/tossim/MAC_SMAC.nc"
static inline void MAC_SMAC$send_transmit_done_cts(sim_event_t *evt)
#line 947
{
  MAC_SMAC$cts[sim_node()] = (void *)0;
  MAC_SMAC$transmitting[sim_node()] = FALSE;

  MAC_SMAC$waiting_fordata[sim_node()] = TRUE;
  sim_log_debug(175U, "TossimPacketModelC", "PACKET: Signaling CTS send done at %llu.\n", sim_time());
}
...
{
  sim_time_t duration;
  tossim_metadata_t *metadata = MAC_SMAC$getMetadata(&MAC_SMAC$ctspacket[sim_node()]);

  duration = 8 * (sizeof MAC_SMAC$ctspacket[sim_node()] + MAC_SMAC$sim_packet_header_length());
  duration /= sim_csma_bits_per_symbol();
  duration += sim_csma_preamble_length();
  duration *= sim_ticks_per_sec() / sim_csma_symbols_per_sec();

  evt->time += duration;
  evt->handle = MAC_SMAC$send_transmit_done_cts;

  sim_log_debug(173U, "TossimPacketModelC", "PACKET: Broadcasting CTS packet to everyone. time: %llu\n", sim_time());





  MAC_SMAC$GainRadioModel$putOnAirTo(AM_BROADCAST_ADDR, &MAC_SMAC$ctspacket[sim_node()], __nesc_ntoh_uint8(metadata->ack.nxdata), evt->time, 0.0, 0.0);
  __nesc_hton_uint8(metadata->ack.nxdata, 0);

  evt->time += sim_csma_rxtx_delay() * (sim_ticks_per_sec() / sim_csma_symbols_per_sec());

  sim_log_debug(174U, "TossimPacketModelC", "PACKET: CTS Send done at %llu.\n", evt->time);
...
#line 872
{
  ...
  if (MAC_SMAC$running[sim_node()]) {
      MAC_SMAC$ctsbackoffCount[sim_node()]++;
      ...
      if (MAC_SMAC$GainRadioModel$clearChannel()) {
          ...
          MAC_SMAC$transmitting[sim_node()] = TRUE;
          MAC_SMAC$GainRadioModel$setPendingTransmission();
          evt->handle = MAC_SMAC$send_transmit_cts;
          delay = sim_csma_rxtx_delay();
          delay *= sim_ticks_per_sec() / sim_csma_symbols_per_sec();
          evt->time += delay;
          ...
          if (MAC_SMAC$ctsbackoffCount[sim_node()] <= 20) {
              ...
              sim_log_debug(171U, "TossimPacketModelC", "PACKET: Failed to send CTS packet due to busy channel.\n");
              MAC_SMAC$radio_locked[sim_node()] = FALSE;
            }
        }
    }
    ...
    {
      sim_log_debug(172U, "TossimPacketModelC", "PACKET: Radio sleeping while sending CTS, so backing off. Time =  %llu.\n", sim_time());
    }
}

# 73 "/opt/tinyos-2_1_2/tos/lib/timer/Timer.nc"
inline static void MAC_SMAC$activeTimer$startOneShot(uint32_t dt){
#line 73
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$startOneShot(4U, dt);
#line 73
}
#line 73
# 156 "/home/mehrkavir-lap1/tWorkspace/smac-1.0/src/SmacC.nc"
static inline void SmacC$iSMAC$syncReceived(uint16_t node_id)
#line 156
{
  sim_log_debug(266U, "DebugApp", "\t New sync received from %i. \t@%s\n", node_id, sim_time_string());
  if (SmacC$myState[sim_node()] == 1 && !SmacC$hasCH[sim_node()]) {
      if (!SmacC$isAppearance[sim_node()]) {
          if (SmacC$Appearance$isRunning()) {
            SmacC$Appearance$stop();
            }
#line 162
      ...
      SmacC$myState[sim_node()] = 1;
      SmacC$myCH_ID[sim_node()] = node_id;
      SmacC$hasCH[sim_node()] = TRUE;

      sim_log_debug(267U, "DebugApp", "\t Node %i joined to %i as member. \t@%s\n", TOS_NODE_ID, SmacC$myCH_ID[sim_node()], sim_time_string());
      sim_log_debug(268U, "DebugGraph", ";%i;%i;Mote;1 \n", TOS_NODE_ID, SmacC$myCH_ID[sim_node()]);
    }
}

# 9 "/home/mehrkavir-lap1/tWorkspace/smac-1.0/src/iSMAC.nc"
inline static void MAC_SMAC$iSMAC$syncReceived(uint16_t node_id){
#line 9
  SmacC$iSMAC$syncReceived(node_id);
#line 9
}
#line 9
# 1139 "/opt/tinyos-2_1_2/tos/lib/tossim/MAC_SMAC.nc"
static inline void MAC_SMAC$GainRadioModel$receive(message_t *msg)
#line 1139
{

  if (MAC_SMAC$running[sim_node()] && !MAC_SMAC$transmitting[sim_node()]) {





      MAC_SMAC$syn3[sim_node()] = (RTS_packet_t *)MAC_SMAC$ConPacket$getPayload(msg, 25);
      sim_log_debug(189U, "TossimPacketModelC", "TossimPacketModelC: In GainRadioModel.receive, Received packet of type %hu\n", __nesc_ntoh_uint16(MAC_SMAC$syn3[sim_node()]->packet_type.nxdata));

      if (MAC_SMAC$syn3[sim_node()] == (void *)0) {
          sim_log_debug(190U, "TossimPacketModelC", "TossimPacketModelC: syn3 was null\n");
          return;
        }

      if (__nesc_ntoh_uint16(MAC_SMAC$syn3[sim_node()]->packet_type.nxdata) == 1) {
          MAC_SMAC$syn_rec[sim_node()] = (SYN_packet_t *)MAC_SMAC$ConPacket$getPayload(msg, 25);
          sim_log_debug(191U, "TossimPacketModelC", "TossimPacketModelC: In GainRadioModel.receive, Received a SYN packet from node %hu, time: %llu\n", __nesc_ntoh_int16(MAC_SMAC$syn_rec[sim_node()]->node_id.nxdata), sim_time());
          if (__nesc_ntoh_int16(MAC_SMAC$syn_rec[sim_node()]->node_id.nxdata) != sim_node()) {

              MAC_SMAC$iSMAC$syncReceived(__nesc_ntoh_int16(MAC_SMAC$syn_rec[sim_node()]->node_id.nxdata));

              MAC_SMAC$noSYN_rec[sim_node()]++;
              if (MAC_SMAC$syn_sentbyme[sim_node()]) {
                  MAC_SMAC$imborderNode[sim_node()] = MAC_SMAC$borderNode_process();
                }
              else {
                  MAC_SMAC$isFollower[sim_node()] = TRUE;
                  sim_log_debug(192U, "TossimPacketModelC", "TossimPacketModelC: In GainRadioModel.receive, following schedule, started active timer %hu\n", __nesc_ntoh_uint16(MAC_SMAC$syn_rec[sim_node()]->next_sleep_time.nxdata));
                  if (MAC_SMAC$alreadyTryingforSYNC[sim_node()]) {



                      if (MAC_SMAC$noSYN_rec[sim_node()] >= 2) {
                          MAC_SMAC$imborderNode[sim_node()] = MAC_SMAC$borderNode_process();
                        }
                      else {
                          MAC_SMAC$ACTIVE_PERIOD[sim_node()] = __nesc_ntoh_uint16(MAC_SMAC$syn_rec[sim_node()]->next_sleep_time.nxdata);
                          MAC_SMAC$activeTimer$startOneShot(MAC_SMAC$ACTIVE_PERIOD[sim_node()]);
                        }
                    }
                  else {
                      if (MAC_SMAC$noSYN_rec[sim_node()] >= 2) {
                          MAC_SMAC$imborderNode[sim_node()] = MAC_SMAC$borderNode_process();
                          if (MAC_SMAC$imborderNode[sim_node()] == FALSE) {

                              sim_log_debug(193U, "TossimPacketModelC", "TossimPacketModelC: After receiving SYNC, rebroadcasting. time: %llu\n", sim_time());
                              MAC_SMAC$start_syn();
                            }
                        }
                      else 
...
#line 1199
        if (__nesc_ntoh_uint16(MAC_SMAC$syn3[sim_node()]->packet_type.nxdata) == 2) {
            MAC_SMAC$rts_rec[sim_node()] = (RTS_packet_t *)MAC_SMAC$ConPacket$getPayload(msg, 25);
            if (MAC_SMAC$rts_rec[sim_node()] == (void *)0) {
                sim_log_debug(194U, "TossimPacketModelC", "TossimPacketModelC: In GainRadioModel.receive, rts_rec is NULL\n");
              }
            sim_log_debug(195U, "TossimPacketModelC", "TossimPacketModelC: In GainRadioModel.receive, Received a RTS packet of type %hu from: %hu for: %hu  time: %llu\n", __nesc_ntoh_uint16(MAC_SMAC$rts_rec[sim_node()]->packet_type.nxdata), __nesc_ntoh_int16(MAC_SMAC$rts_rec[sim_node()]->src_id.nxdata), __nesc_ntoh_int16(MAC_SMAC$rts_rec[sim_node()]->dest_id.nxdata), sim_time());

            if (__nesc_ntoh_int16(MAC_SMAC$rts_rec[sim_node()]->dest_id.nxdata) == sim_node()) {
                if (!MAC_SMAC$waiting_fordata[sim_node()] && !MAC_SMAC$gotrts_sleepTimer$isRunning()) {
                    MAC_SMAC$radio_locked[sim_node()] = TRUE;

                    MAC_SMAC$cts[sim_node()] = (CTS_packet_t *)MAC_SMAC$ConPacket$getPayload(&MAC_SMAC$ctspacket[sim_node()], sizeof(CTS_packet_t ));
                    __nesc_hton_uint16(MAC_SMAC$cts[sim_node()]->packet_type.nxdata, 3);
                    __nesc_hton_int16(MAC_SMAC$cts[sim_node()]->src_id.nxdata, sim_node());
                    __nesc_hton_int16(MAC_SMAC$cts[sim_node()]->dest_id.nxdata, __nesc_ntoh_int16(MAC_SMAC$rts_rec[sim_node()]->src_id.nxdata));
                    __nesc_hton_uint16(MAC_SMAC$cts[sim_node()]->duration.nxdata, __nesc_ntoh_uint16(MAC_SMAC$rts_rec[sim_node()]->duration.nxdata));
                    ...
                    MAC_SMAC$sample_time[sim_node()] = sim_time();

                    MAC_SMAC$CTSsendEvent[sim_node()].mote = sim_node();
                    MAC_SMAC$CTSsendEvent[sim_node()].time = MAC_SMAC$sample_time[sim_node()];
                    MAC_SMAC$CTSsendEvent[sim_node()].force = 0;
                    MAC_SMAC$CTSsendEvent[sim_node()].cancelled = 0;
                    MAC_SMAC$CTSsendEvent[sim_node()].handle = MAC_SMAC$send_cts;
                    MAC_SMAC$CTSsendEvent[sim_node()].cleanup = sim_queue_cleanup_none;
                    sim_queue_insert(&MAC_SMAC$CTSsendEvent[sim_node()]);
                    sim_log_debug(196U, "TossimPacketModelC", "TossimPacketModelC: In GainRadioModel.receive, Sending a CTS packet to node %hu\n", __nesc_ntoh_int16(MAC_SMAC$cts[sim_node()]->dest_id.nxdata));

                    MAC_SMAC$CTSwaitTimer$startOneShot(30);
                  }
              }
            else 
              {
                if (!MAC_SMAC$radio_locked[sim_node()]) {
                    sim_log_debug(197U, "TossimPacketModelC", "TossimPacketModelC: In GainRadioModel.receive, RTS for %hu was received, Going to stop radio. Duration = %llu \n", __nesc_ntoh_int16(MAC_SMAC$rts_rec[sim_node()]->dest_id.nxdata), __nesc_ntoh_uint16(MAC_SMAC$rts_rec[sim_node()]->duration.nxdata));
                    MAC_SMAC$gotrts_sleepTimer$startOneShot(__nesc_ntoh_uint16(MAC_SMAC$rts_rec[sim_node()]->duration.nxdata) / 4500);
                    MAC_SMAC$Control$stop();
                  }
              }
          }
...
#line 1245
          if (__nesc_ntoh_uint16(MAC_SMAC$syn3[sim_node()]->packet_type.nxdata) == 3) {
              MAC_SMAC$cts_rec[sim_node()] = (CTS_packet_t *)MAC_SMAC$ConPacket$getPayload(msg, sizeof(CTS_packet_t ));
              sim_log_debug(198U, "TossimPacketModelC", "TossimPacketModelC: In GainRadioModel.receive, Received a CTS packet from: %hu for: %hu  time:%llu\n", __nesc_ntoh_int16(MAC_SMAC$cts_rec[sim_node()]->src_id.nxdata), __nesc_ntoh_int16(MAC_SMAC$cts_rec[sim_node()]->dest_id.nxdata), sim_time());

              if (__nesc_ntoh_int16(MAC_SMAC$cts_rec[sim_node()]->dest_id.nxdata) == sim_node()) {
                  if (!MAC_SMAC$gotrts_sleepTimer$isRunning()) {
                      MAC_SMAC$rts[sim_node()] = (void *)0;
                      MAC_SMAC$RTSwaitTimer$stop();
                      MAC_SMAC$totalRTSCount[sim_node()] = 0;
                      sim_log_debug(199U, "TossimPacketModelC", "TossimPacketModelC: In GainRadioModel.receive, Sending data \n");
                      MAC_SMAC$no_SendTry[sim_node()] = 0;
                      if (MAC_SMAC$sending[sim_node()] != (void *)0) {
                        MAC_SMAC$send_data();
                        }
                    }
...
#line 1260
                {
                  if (!MAC_SMAC$radio_locked[sim_node()]) {
                      sim_log_debug(200U, "TossimPacketModelC", "TossimPacketModelC: In GainRadioModel.receive, CTS for node %hu was received, Going to stop radio. \n", __nesc_ntoh_int16(MAC_SMAC$cts_rec[sim_node()]->dest_id.nxdata));
                      MAC_SMAC$gotrts_sleepTimer$startOneShot(__nesc_ntoh_uint16(MAC_SMAC$cts_rec[sim_node()]->duration.nxdata) / 5500);
                      MAC_SMAC$Control$stop();
                    }
                }
            }
              ...
              tossim_header_t *header = (tossim_header_t *)MAC_SMAC$getHeaderdata(msg);

              if (__nesc_ntoh_uint16(header->dest.nxdata) != sim_node()) {
                  sim_log_debug(201U, "TossimPacketModelC", "TossimPacketModelC: In GainRadioModel.receive, received packet for %hu, discarding it.\n", __nesc_ntoh_uint16(header->dest.nxdata));
                  return;
                }

              MAC_SMAC$data_rec[sim_node()] = (data_packet_t *)MAC_SMAC$ConPacket$getPayload(msg, sizeof(data_packet_t ));

              MAC_SMAC$CTSwaitTimer$stop();
              MAC_SMAC$waiting_fordata[sim_node()] = FALSE;
              ...
              payload = MAC_SMAC$ConPacket$getPayload(buffer, MAC_SMAC$ConPacket$maxPayloadLength());

              sim_log_debug(202U, "TossimPacketModelC", "TossimPacketModelC: In GainRadioModel.receive, rec_counter = %hu \n", __nesc_ntoh_uint8(MAC_SMAC$data_rec[sim_node()]->payload[1].nxdata));
              memcpy(payload, MAC_SMAC$data_rec[sim_node()]->payload, dataLen);




              MAC_SMAC$radio_locked[sim_node()] = FALSE;
              sim_log_debug(203U, "TossimPacketModelC", "TossimPacketModelC: In GainRadioModel.receive, Received a data packet , data_rec2->payload[1]=%hu\n", __nesc_ntoh_uint8(MAC_SMAC$data_rec2[sim_node()]->payload[1].nxdata));
              MAC_SMAC$Packet$receive(buffer);
...
#line 1313
  MAC_SMAC$syn3[sim_node()] = (void *)0;
  MAC_SMAC$rts_rec[sim_node()] = (void *)0;
  MAC_SMAC$cts_rec[sim_node()] = (void *)0;
  MAC_SMAC$syn_rec[sim_node()] = (void *)0;
}

# 60 "/opt/tinyos-2_1_2/tos/lib/tossim/GainRadioModel.nc"
inline static void CpmModelC$Model$receive(message_t *msg){
#line 60
  MAC_SMAC$GainRadioModel$receive(msg);
#line 60
}
#line 60
...
#line 296
{
  ...
  sim_log_debug(243U, "CpmModelC", "Handling reception event @ %s.\n", sim_time_string());
  while (list != (void *)0) {
      if (list->next == mine) {
          predecessor = list;
        }
...
#line 311
    if (mine == CpmModelC$outstandingReceptionHead[sim_node()]) {
        ...
        sim_log_error(244U, "CpmModelC", "Incoming packet list structure is corrupted: entry is not the head and no entry points to it.\n");
      }
    }
#line 317
  sim_log_debug(245U, "CpmModelC,SNRLoss", "Packet from %i to %i\n", (int )mine->source, (int )sim_node());
  if (!CpmModelC$checkReceive(mine)) {
      sim_log_debug(246U, "CpmModelC,SNRLoss", " - lost packet from %i as SNR was too low.\n", (int )mine->source);
      mine->lost = 1;
    }
  if (! mine->lost) {
...
#line 327
      ...
      sim_log_debug_clear(247U, "CpmModelC,SNRLoss", "  -signaling reception\n");
      CpmModelC$Model$receive(mine->msg);
      if (mine->ack) {
          sim_log_debug_clear(248U, "CpmModelC", " acknowledgment requested, ");
        }
      else {
          sim_log_debug_clear(249U, "CpmModelC", " no acknowledgment requested.\n");
        }

      if (mine->ack && CpmModelC$Model$shouldAck(mine->msg)) {
          sim_log_debug_clear(250U, "CpmModelC", " scheduling ack.\n");
      ...
      if (RandomUniform() < 0.001) {
          sim_log_debug(251U, "CpmModelC,SNRLoss", "Packet was technically lost, but TOSSIM introduces an ack false positive rate.\n");
          if (mine->ack && CpmModelC$Model$shouldAck(mine->msg)) {
              sim_log_debug_clear(252U, "CpmModelC", " scheduling ack.\n");
              CpmModelC$sim_gain_schedule_ack(mine->source, sim_time() + 1, mine);
            }
          else {
              CpmModelC$free_receive_message(mine);
      ...
      CpmModelC$receiving[sim_node()] = 0;
      sim_log_debug_clear(253U, "CpmModelC,SNRLoss", "  -packet was lost.\n");
    }
}
...
#line 374
  ...
  if (!sim_mote_is_on(sim_node())) {
      sim_log_debug(254U, "CpmModelC", "Lost packet from %i due to %i being off\n", source, sim_node());
      rcv->lost = 1;
    }
  else {
#line 396
    if (!CpmModelC$shouldReceive(power - noiseStr)) {
        sim_log_debug(255U, "CpmModelC,SNRLoss", "Lost packet from %i to %i due to SNR being too low (%i)\n", source, sim_node(), (int )(power - noiseStr));
        rcv->lost = 1;
      }
    else {
#line 400
      if (CpmModelC$receiving[sim_node()]) {
          sim_log_debug(256U, "CpmModelC,SNRLoss", "Lost packet from %i due to %i being mid-reception\n", source, sim_node());
          rcv->lost = 1;
        }
      else {
#line 404
        if (CpmModelC$transmitting[sim_node()] && rcv->start < CpmModelC$transmissionEndTime[sim_node()] && CpmModelC$transmissionEndTime[sim_node()] <= rcv->end) {
            sim_log_debug(257U, "CpmModelC,SNRLoss", "Lost packet from %i due to %i being mid-transmission, transmissionEndTime %llu\n", source, sim_node(), CpmModelC$transmissionEndTime[sim_node()]);
            rcv->lost = 1;
          }
        else {
...
#line 412
  ...
  while (list != (void *)0) {
      if (!CpmModelC$shouldReceive(list->power - rcv->power)) {
          sim_log_debug(258U, "Gain,SNRLoss", "Going to lose packet from %i with signal %lf as am receiving a packet from %i with signal %lf\n", list->source, list->power, source, rcv->power);
          list->lost = 1;
        }
      list = list->next;
    }
...
#line 430
  sim_log_debug(259U, "CpmModelC", "Enqueing reception event for %i at %llu with power %lf.\n", dest, endTime, power);
  sim_set_node(dest);
...
#line 239
  sim_log_debug(242U, "CpmModelC,SNR", "SNR is %lf, PRR is %lf\n", SNR, prr_hat);
  if (prr_hat > 1) {
    prr_hat = 1.1;
    }
  else {
...
# 92 "/opt/tinyos-2_1_2/tos/lib/timer/Timer.nc"
inline static bool MAC_SMAC$SYNwaitTimer$isRunning(void ){
#line 92
  unsigned char __nesc_result;
#line 92
...
#line 92
# 376 "/opt/tinyos-2_1_2/tos/lib/tossim/MAC_SMAC.nc"
static inline void MAC_SMAC$send_transmit_done_syn(sim_event_t *evt)
#line 376
{
  MAC_SMAC$transmitting[sim_node()] = FALSE;
  MAC_SMAC$syn[sim_node()] = (void *)0;
  MAC_SMAC$syn_sentbyme[sim_node()] = TRUE;
  sim_log_debug(139U, "TossimPacketModelC", "PACKET: Signaling SYN send done at %llu.\n", sim_time());
}

# 194 "/opt/tinyos-2_1_2/tos/lib/timer/VirtualizeTimerC.nc"
static inline uint32_t /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$gett0(uint8_t num)
{
...
# 144 "/opt/tinyos-2_1_2/tos/lib/timer/Timer.nc"
inline static uint32_t MAC_SMAC$activeTimer$gett0(void ){
#line 144
  unsigned int __nesc_result;
#line 144
...
#line 144
# 189 "/opt/tinyos-2_1_2/tos/lib/timer/VirtualizeTimerC.nc"
static inline uint32_t /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$getNow(uint8_t num)
{
...
# 136 "/opt/tinyos-2_1_2/tos/lib/timer/Timer.nc"
inline static uint32_t MAC_SMAC$activeTimer$getNow(void ){
#line 136
  unsigned int __nesc_result;
#line 136
...
#line 136
# 329 "/opt/tinyos-2_1_2/tos/lib/tossim/MAC_SMAC.nc"
static inline void MAC_SMAC$send_transmit_syn(sim_event_t *evt)
#line 329
{
  if (!MAC_SMAC$syn_sentbyme[sim_node()]) {
      sim_time_t duration;
      tossim_metadata_t *metadata = MAC_SMAC$getMetadata(&MAC_SMAC$synpacket[sim_node()]);

      __nesc_hton_uint16(MAC_SMAC$syn[sim_node()]->next_sleep_time.nxdata, MAC_SMAC$ACTIVE_PERIOD[sim_node()] - (MAC_SMAC$activeTimer$getNow() - MAC_SMAC$activeTimer$gett0()));
      sim_log_debug(135U, "TossimPacketModelC", "PACKET: Next Sleep time: %hu\n", __nesc_ntoh_uint16(MAC_SMAC$syn[sim_node()]->next_sleep_time.nxdata));
      duration = 8 * (sizeof MAC_SMAC$synpacket[sim_node()] + MAC_SMAC$sim_packet_header_length());
      duration /= sim_csma_bits_per_symbol();
      duration += sim_csma_preamble_length();
      ...
      __nesc_hton_uint16(MAC_SMAC$syn[sim_node()]->next_sleep_time.nxdata, __nesc_ntoh_uint16(MAC_SMAC$syn[sim_node()]->next_sleep_time.nxdata) - (float )duration / 100000000);
      __nesc_hton_uint16(MAC_SMAC$syn[sim_node()]->sleep_period.nxdata, MAC_SMAC$SLEEP_PERIOD[sim_node()]);
      evt->time += duration;
      evt->handle = MAC_SMAC$send_transmit_done_syn;

      if (!MAC_SMAC$syn_sentbyme[sim_node()] && MAC_SMAC$imborderNode[sim_node()] == FALSE && MAC_SMAC$SYNwaitTimer$isRunning()) {
          sim_log_debug(136U, "TossimPacketModelC", "PACKET: Broadcasting syn synpacket to everyone. Duration:%llu ,time: %llu\n", duration, sim_time());
          sim_log_debug(137U, "TossimPacketModelC", "PACKET: Next Sleep time: %hu\n", __nesc_ntoh_uint16(MAC_SMAC$syn[sim_node()]->next_sleep_time.nxdata));





          MAC_SMAC$GainRadioModel$putOnAirTo(AM_BROADCAST_ADDR, &MAC_SMAC$synpacket[sim_node()], __nesc_ntoh_uint8(metadata->ack.nxdata), evt->time, 0.0, 0.0);
          __nesc_hton_uint8(metadata->ack.nxdata, 0);

          evt->time += sim_csma_rxtx_delay() * (sim_ticks_per_sec() / sim_csma_symbols_per_sec());

          sim_log_debug(138U, "TossimPacketModelC", "PACKET: syn Send done at %llu.\n", evt->time);
...
#line 287
{
  sim_log_debug(132U, "TossimPacketModelC", "SYNPACKET: here3\n");
  if (MAC_SMAC$running[sim_node()]) {
      MAC_SMAC$synbackoffCount[sim_node()]++;
      if (MAC_SMAC$GainRadioModel$clearChannel()) {
          if ((!MAC_SMAC$isFollower[sim_node()] || !MAC_SMAC$syn_sentbyme[sim_node()]) && !MAC_SMAC$imborderNode[sim_node()]) {
              sim_time_t delay;
...
#line 294
              ...
              MAC_SMAC$GainRadioModel$setPendingTransmission();
              evt->handle = MAC_SMAC$send_transmit_syn;

              sim_queue_insert(evt);
              sim_log_debug(133U, "TossimPacketModelC", "SYNPACKET: here3\n");
            }
        }
      else {


          if (MAC_SMAC$synbackoffCount[sim_node()] <= 20) {
              MAC_SMAC$backoff2[sim_node()] = sim_random();
              MAC_SMAC$backoff2[sim_node()] %= sim_csma_init_high() - sim_csma_init_low();
              MAC_SMAC$backoff2[sim_node()] += sim_csma_init_low();
              MAC_SMAC$backoff2[sim_node()] *= sim_ticks_per_sec() / sim_csma_symbols_per_sec();

              evt->time += MAC_SMAC$backoff2[sim_node()] * 1000;
              sim_queue_insert(evt);
            }
          else 
            {
              sim_log_debug(134U, "TossimPacketModelC", "PACKET: Failed to send SYN no %hu packet due to busy channel.\n", MAC_SMAC$totalRTSCount[sim_node()]);
            }
        }
    }
}
...
inline static bool MAC_SMAC$Packet$shouldAck(message_t *msg){
#line 87
  unsigned char __nesc_result;
#line 87
...
#line 87
# 1322 "/opt/tinyos-2_1_2/tos/lib/tossim/MAC_SMAC.nc"
static inline void MAC_SMAC$GainRadioModel$acked(message_t *msg)
#line 1322
{
  if (MAC_SMAC$running[sim_node()]) {
...
#line 1325
      __nesc_hton_uint8(metadata->ack.nxdata, 1);
      if (msg != MAC_SMAC$sending[sim_node()]) {
          MAC_SMAC$error[sim_node()] = 1;
          sim_log_debug(204U, "TossimPacketModelC", "Requested ack for 0x%x, but outgoing packet is 0x%x.\n", msg, MAC_SMAC$sending[sim_node()]);
        }
    }
}
...
#line 59
  MAC_SMAC$GainRadioModel$acked(msg);
#line 59
}
#line 59
...
#line 157
  sim_log_debug(239U, "CpmModelC,SNRLoss", "SNR is %lf, ARR is %lf\n", SNR, prr_hat);
  if (prr_hat > 1) {
    prr_hat = 1.1;
    }
  else {
...
# 73 "/opt/tinyos-2_1_2/tos/lib/timer/Timer.nc"
inline static void MAC_SMAC$RTSwaitTimer$startOneShot(uint32_t dt){
#line 73
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$startOneShot(1U, dt);
#line 73
}
#line 73
# 855 "/opt/tinyos-2_1_2/tos/lib/tossim/MAC_SMAC.nc"
static inline void MAC_SMAC$send_transmit_done_rts(sim_event_t *evt)
#line 855
{

  if (MAC_SMAC$sending[sim_node()] != (void *)0) {
      MAC_SMAC$noRTSCount[sim_node()]++;
      MAC_SMAC$totalRTSCount[sim_node()]++;
      MAC_SMAC$transmitting[sim_node()] = FALSE;
      MAC_SMAC$radio_locked[sim_node()] = TRUE;
      sim_log_debug(170U, "TossimPacketModelC", "PACKET: Signaling RTS no %hu send done at %llu.\n", MAC_SMAC$totalRTSCount[sim_node()], sim_time());
      if (MAC_SMAC$noRTSCount[sim_node()] <= 2 + 1) {
        MAC_SMAC$RTSwaitTimer$startOneShot(30);
        }
    }
}
...
#line 815
{
  ...
  tossim_metadata_t *metadata = MAC_SMAC$getMetadata(&MAC_SMAC$rtspacket[sim_node()]);

#line 819
  sim_log_debug(166U, "TossimPacketModelC", "Trying to send RTS, in send_transmit_rts. noRTSCount=%hu Time = %llu\n", MAC_SMAC$noRTSCount[sim_node()], sim_time());

  duration = 8 * (sizeof MAC_SMAC$rtspacket[sim_node()] + MAC_SMAC$sim_packet_header_length());
  duration /= sim_csma_bits_per_symbol();
  duration += sim_csma_preamble_length();
  ...
  evt->time += duration;
  evt->handle = MAC_SMAC$send_transmit_done_rts;

  sim_log_debug(167U, "TossimPacketModelC", "PACKET: Broadcasting rts rtspacket no %hu to everyone. time: %llu\n", MAC_SMAC$totalRTSCount[sim_node()], sim_time());





  MAC_SMAC$GainRadioModel$putOnAirTo(AM_BROADCAST_ADDR, &MAC_SMAC$rtspacket[sim_node()], __nesc_ntoh_uint8(metadata->ack.nxdata), evt->time, 0.0, 0.0);
  sim_log_debug(168U, "TossimPacketModelC", "PACKET: Broadcasting rts rtspacket no %hu to everyone. time: %llu\n", MAC_SMAC$totalRTSCount[sim_node()], sim_time());
  __nesc_hton_uint8(metadata->ack.nxdata, 0);

  evt->time += sim_csma_rxtx_delay() * (sim_ticks_per_sec() / sim_csma_symbols_per_sec());

  sim_log_debug(169U, "TossimPacketModelC", "PACKET: RTS no %hu Send done at %llu.\n", MAC_SMAC$totalRTSCount[sim_node()], evt->time);
...
# 92 "/opt/tinyos-2_1_2/tos/lib/timer/Timer.nc"
inline static bool MAC_SMAC$activeTimer$isRunning(void ){
#line 92
  unsigned char __nesc_result;
#line 92
...
#line 92
#line 136
inline static uint32_t MAC_SMAC$sleepTimer$getNow(void ){
#line 136
  unsigned int __nesc_result;
#line 136
...
inline static uint32_t MAC_SMAC$sleepTimer$gett0(void ){
#line 144
  unsigned int __nesc_result;
#line 144

#line 144
  __nesc_result = /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$gett0(5U);
#line 144
...
#line 144
#line 136
inline static uint32_t MAC_SMAC$SYNwaitTimer$getNow(void ){
#line 136
  unsigned int __nesc_result;
#line 136
...
inline static uint32_t MAC_SMAC$SYNwaitTimer$gett0(void ){
#line 144
  unsigned int __nesc_result;
#line 144

#line 144
  __nesc_result = /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$gett0(3U);
#line 144
...
#line 67
# 386 "/opt/tinyos-2_1_2/tos/lib/tossim/MAC_SMAC.nc"
static inline void MAC_SMAC$gotrts_sleepTimer$fired(void )
#line 386
{

  if (MAC_SMAC$sleepTimer$isRunning()) {
      sim_log_debug(140U, "TossimPacketModelC", "In gotrts_sleepTimer fired, Its My sleeping time, going to sleep time %llu\n", sim_time());
      MAC_SMAC$Control$stop();
    }
  else {
      sim_log_debug(141U, "TossimPacketModelC", "gotrts_sleepTimer fired, now waking up at time %llu\n", sim_time());
      MAC_SMAC$Control$start();
      if (MAC_SMAC$sending[sim_node()] != (void *)0) {
          sim_log_debug(142U, "TossimPacketModelC", "In gotrts_sleepTimer fired, have a pending transmision, sending RTS %llu\n", sim_time());
          MAC_SMAC$start_rts();
        }
    }
}
...
#line 413
{
  sim_log_debug(145U, "TossimPacketModelC", "RTSwaitTimer fired, Packet has been dropped. noRTSCount=%hu Time = %llu\n", MAC_SMAC$noRTSCount[sim_node()], sim_time());

  if (MAC_SMAC$sending[sim_node()] != (void *)0) {
      if (MAC_SMAC$totalRTSCount[sim_node()] == 2 * (2 + 1)) {
          MAC_SMAC$totalRTSCount[sim_node()] = 0;




          MAC_SMAC$Packet$sendDone(MAC_SMAC$sending[sim_node()], EBUSY);
          sim_log_debug(146U, "TossimPacketModelC", "In RTSwaitTimer fired. Making sending NULL Time = %llu\n", sim_time());

          MAC_SMAC$sending[sim_node()] = (void *)0;

          MAC_SMAC$radio_locked[sim_node()] = FALSE;
          sim_log_debug(147U, "TossimPacketModelC", "In RTSwaitTimer fired. Making sending NULL Time = %llu\n", sim_time());
          return;
        }
      if (MAC_SMAC$noRTSCount[sim_node()] > 2) {
          MAC_SMAC$radio_locked[sim_node()] = FALSE;
          MAC_SMAC$noRTSCount[sim_node()] = 0;
        }
      else {
          sim_log_debug(148U, "TossimPacketModelC", "RTSwaitTimer fired, retransmitting the RTS. noRTSCount=%hu Time = %llu\n", MAC_SMAC$noRTSCount[sim_node()], sim_time());

          MAC_SMAC$backoff2[sim_node()] = sim_random();
          MAC_SMAC$backoff2[sim_node()] %= sim_csma_init_high() - sim_csma_init_low();
          MAC_SMAC$backoff2[sim_node()] += sim_csma_init_low();
          MAC_SMAC$backoff2[sim_node()] *= sim_ticks_per_sec() / sim_csma_symbols_per_sec();
          MAC_SMAC$sample_time[sim_node()] = sim_time() + MAC_SMAC$backoff2[sim_node()] - 8000000;

          MAC_SMAC$RTSsendEvent[sim_node()].mote = sim_node();
          MAC_SMAC$RTSsendEvent[sim_node()].time = MAC_SMAC$sample_time[sim_node()];
          MAC_SMAC$RTSsendEvent[sim_node()].force = 0;
          MAC_SMAC$RTSsendEvent[sim_node()].cancelled = 0;
          MAC_SMAC$RTSsendEvent[sim_node()].handle = MAC_SMAC$send_rts;
          MAC_SMAC$RTSsendEvent[sim_node()].cleanup = sim_queue_cleanup_none;
          sim_queue_insert(&MAC_SMAC$RTSsendEvent[sim_node()]);

          sim_log_debug(149U, "TossimPacketModelC", "RTSwaitTimer fired, retransmitting the RTS. noRTSCount=%hu Time = %llu\n", MAC_SMAC$noRTSCount[sim_node()], sim_time());
        }
    }
}
...
{
  MAC_SMAC$radio_locked[sim_node()] = FALSE;
  sim_log_debug(144U, "TossimPacketModelC", "CTSwaitTimer fired, giving up waiting for data %llu\n", sim_time());
  MAC_SMAC$waiting_fordata[sim_node()] = FALSE;
}
...
#line 402
{
  sim_log_debug(143U, "TossimPacketModelC", "SYNwaitTimer fired, now can do transmission %llu\n", sim_time());
  MAC_SMAC$syn_done[sim_node()] = TRUE;
}

# 73 "/opt/tinyos-2_1_2/tos/lib/timer/Timer.nc"
inline static void MAC_SMAC$sleepTimer$startOneShot(uint32_t dt){
#line 73
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$startOneShot(5U, dt);
#line 73
}
#line 73
# 103 "/home/mehrkavir-lap1/tWorkspace/smac-1.0/src/SmacC.nc"
static inline void SmacC$iSMAC$activationChanged(uint8_t status)
#line 103
{
}
...
# 8 "/home/mehrkavir-lap1/tWorkspace/smac-1.0/src/iSMAC.nc"
inline static void MAC_SMAC$iSMAC$activationChanged(uint8_t status){
#line 8
  SmacC$iSMAC$activationChanged(status);
#line 8
}
#line 8
# 171 "/opt/tinyos-2_1_2/tos/lib/tossim/MAC_SMAC.nc"
static inline void MAC_SMAC$activeTimer$fired(void )
#line 171
{
  sim_log_debug(123U, "TossimPacketModelC", "TossimPacketModelC: Active timer fired at time = %llu.\n", sim_time());

  if (MAC_SMAC$SYNwaitTimer$isRunning()) {
    return;
    }
  if (!MAC_SMAC$radio_locked[sim_node()]) {
      sim_log_debug(124U, "TossimPacketModelC", "TossimPacketModelC: Going to Turn Radio OFF\n");
      MAC_SMAC$Control$stop();
      ...
      MAC_SMAC$iSMAC$activationChanged(0);
    }
  else 
    {
      sim_log_debug(125U, "TossimPacketModelC", "TossimPacketModelC: Want to Turn Radio OFF, but Radio locked\n");
    }

  MAC_SMAC$sleepTimer$startOneShot(MAC_SMAC$SLEEP_PERIOD[sim_node()]);
  MAC_SMAC$isFollower[sim_node()] = FALSE;
  MAC_SMAC$noSYN_rec[sim_node()] = 0;

  MAC_SMAC$syn_sentbyme[sim_node()] = FALSE;
  MAC_SMAC$imborderNode[sim_node()] = FALSE;
}

# 73 "/opt/tinyos-2_1_2/tos/lib/timer/Timer.nc"
inline static void MAC_SMAC$SYNwaitTimer$startOneShot(uint32_t dt){
#line 73
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$startOneShot(3U, dt);
#line 73
}
#line 73
# 149 "/home/mehrkavir-lap1/tWorkspace/smac-1.0/src/SmacC.nc"
static inline void SmacC$iSMAC$activated(void )
#line 149
{
  SmacC$macIsActive[sim_node()] = TRUE;
}

# 6 "/home/mehrkavir-lap1/tWorkspace/smac-1.0/src/iSMAC.nc"
inline static void MAC_SMAC$iSMAC$activated(void ){
#line 6
  SmacC$iSMAC$activated();
#line 6
}
#line 6
# 200 "/opt/tinyos-2_1_2/tos/lib/tossim/MAC_SMAC.nc"
static inline void MAC_SMAC$sleepTimer$fired(void )
#line 200
{


  MAC_SMAC$iSMAC$activated();
  MAC_SMAC$iSMAC$activationChanged(1);


  sim_log_debug(126U, "TossimPacketModelC", "TossimPacketModelC: Sleep timer fired at time = %llu.\n", sim_time());
  sim_log_debug(127U, "TossimPacketModelC", "TossimPacketModelC: Going to turn Radio ON\n");
  MAC_SMAC$Control$start();
  MAC_SMAC$radioOnbyTimer[sim_node()] = TRUE;
  MAC_SMAC$syn_done[sim_node()] = FALSE;
  ...
  MAC_SMAC$ACTIVE_PERIOD[sim_node()] = 400;
  MAC_SMAC$SLEEP_PERIOD[sim_node()] = 600;
  MAC_SMAC$SYNwaitTimer$startOneShot(100);
  sim_log_debug(128U, "TossimPacketModelC", "TossimPacketModelC: SYNwaitTimer started\n");
  MAC_SMAC$activeTimer$startOneShot(MAC_SMAC$ACTIVE_PERIOD[sim_node()]);

  if (!MAC_SMAC$isFollower[sim_node()] && MAC_SMAC$running[sim_node()]) {
      MAC_SMAC$alreadyTryingforSYNC[sim_node()] = TRUE;
      MAC_SMAC$start_syn();
    }

  if (MAC_SMAC$sending[sim_node()] != (void *)0 && MAC_SMAC$totalRTSCount[sim_node()] != 0) {
      MAC_SMAC$start_rts();
    }
}

# 75 "/opt/tinyos-2_1_2/tos/interfaces/Send.nc"
inline static error_t /*SmacApp.Annonce_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$1$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
inline static void /*SmacApp.Annonce_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$1$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
...
#line 162
#line 103
inline static void /*SmacApp.Annonce_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$1$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
...
#line 55
{
  /*SmacApp.Annonce_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$1$AMPacket$setDestination(msg, dest);
  /*SmacApp.Annonce_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$1$AMPacket$setType(msg, 200);
  return /*SmacApp.Annonce_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$1$Send$send(msg, len);
}

# 80 "/opt/tinyos-2_1_2/tos/interfaces/AMSend.nc"
inline static error_t SmacC$Annonce_SendMsg$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*SmacApp.Annonce_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$1$AMSend$send(addr, msg, len);
#line 80
...
#line 80
# 126 "/opt/tinyos-2_1_2/tos/interfaces/Packet.nc"
inline static void * SmacC$Packet$getPayload(message_t * msg, uint8_t len){
#line 126
  void *__nesc_result;
#line 126
...
#line 126
# 176 "/home/mehrkavir-lap1/tWorkspace/smac-1.0/src/SmacC.nc"
static inline void SmacC$Annonce$fired(void )
#line 176
{
  int i;
...
#line 178
  if (SmacC$radio_locked[sim_node()]) {
...
#line 184
      rsm = (annonce_msg_t *)SmacC$Packet$getPayload(&SmacC$packet[sim_node()], sizeof(annonce_msg_t ));

      sim_log_debug(269U, "DebugApp", "\t Annonce timer Fired. \t@%s\n", sim_time_string());
...
#line 189
        if (SmacC$myState[sim_node()] != 1) {
            __nesc_hton_uint8(rsm->ID_MEMBER.nxdata, (unsigned char )TOS_NODE_ID);
            __nesc_hton_uint8(rsm->state.nxdata, SmacC$myState[sim_node()]);
            __nesc_hton_uint8(rsm->type.nxdata, 1);

            sim_log_debug(270U, "DebugApp", "\t Node annonce as %s. \t@%s\n", SmacC$myState[sim_node()] == 1 ? "Sonsor" : SmacC$myState[sim_node()] == 2 ? "CH" : SmacC$myState[sim_node()] == 3 ? "BaseStation" : "Unkhown", sim_time_string());

            if (SmacC$Annonce_SendMsg$send(AM_BROADCAST_ADDR, &SmacC$packet[sim_node()], sizeof(annonce_msg_t )) == SUCCESS) {
#line 196
                SmacC$radio_locked[sim_node()] = TRUE;
              }
          }
        }
    }
...
#line 201
{
  sim_log_debug(271U, "DebugApp", "\t Appearance fired. \t@%s\n", sim_time_string());

  if (SmacC$myState[sim_node()] == 1 && !SmacC$hasCH[sim_node()] && !SmacC$seeBaseStation[sim_node()]) {
      SmacC$iSMAC$setFollower(1);
      sim_log_debug(272U, "DebugApp", "\t Appearance fired but i'm mote too. \t@%s\n", sim_time_string());
    }
  SmacC$isAppearance[sim_node()] = TRUE;
}

# 75 "/opt/tinyos-2_1_2/tos/interfaces/Send.nc"
inline static error_t /*SmacApp.NewCycle_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$2$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
#line 75
# 162 "/opt/tinyos-2_1_2/tos/interfaces/AMPacket.nc"
inline static void /*SmacApp.NewCycle_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$2$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
  TossimActiveMessageC$AMPacket$setType(amsg, t);
#line 162
}
#line 162
#line 103
inline static void /*SmacApp.NewCycle_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$2$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
  TossimActiveMessageC$AMPacket$setDestination(amsg, addr);
#line 103
}
...
#line 55
{
  /*SmacApp.NewCycle_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$2$AMPacket$setDestination(msg, dest);
  /*SmacApp.NewCycle_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$2$AMPacket$setType(msg, 203);
  return /*SmacApp.NewCycle_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$2$Send$send(msg, len);
}

# 80 "/opt/tinyos-2_1_2/tos/interfaces/AMSend.nc"
inline static error_t SmacC$NewCycle_SendMsg$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*SmacApp.NewCycle_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$2$AMSend$send(addr, msg, len);
#line 80
...
#line 80
# 211 "/home/mehrkavir-lap1/tWorkspace/smac-1.0/src/SmacC.nc"
static inline void SmacC$NewCycle$fired(void )
#line 211
{
  if (SmacC$radio_locked[sim_node()]) {
...
#line 218
        {
          ...
          SmacC$aggregate_val[sim_node()] = 0;
          SmacC$memberCount_received[sim_node()] = 0;

          sim_log_debug(273U, "DebugApp", "\t New cycle started by CH %i.\t@%s\n", TOS_NODE_ID, sim_time_string());

          SmacC$_timeTick_aggregate[sim_node()] = SmacC$_timeTick[sim_node()] + 3;

          if (SmacC$NewCycle_SendMsg$send(AM_BROADCAST_ADDR, &SmacC$packet[sim_node()], sizeof(annonce_msg_t )) == SUCCESS) {
#line 230
              SmacC$radio_locked[sim_node()] = TRUE;
            }
        }
...
# 75 "/opt/tinyos-2_1_2/tos/interfaces/Send.nc"
inline static error_t /*SmacApp.DATA_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$3$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
#line 75
# 162 "/opt/tinyos-2_1_2/tos/interfaces/AMPacket.nc"
inline static void /*SmacApp.DATA_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$3$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
  TossimActiveMessageC$AMPacket$setType(amsg, t);
#line 162
}
#line 162
#line 103
inline static void /*SmacApp.DATA_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$3$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
  TossimActiveMessageC$AMPacket$setDestination(amsg, addr);
#line 103
}
...
#line 55
{
  /*SmacApp.DATA_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$3$AMPacket$setDestination(msg, dest);
  /*SmacApp.DATA_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$3$AMPacket$setType(msg, 204);
  return /*SmacApp.DATA_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$3$Send$send(msg, len);
}

# 80 "/opt/tinyos-2_1_2/tos/interfaces/AMSend.nc"
inline static error_t SmacC$Data_SendMsg$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*SmacApp.DATA_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$3$AMSend$send(addr, msg, len);
#line 80
...
#line 80
# 89 "/opt/tinyos-2_1_2/tos/system/RandomMlcgC.nc"
static inline uint16_t RandomMlcgC$Random$rand16(void )
#line 89
{
...
# 52 "/opt/tinyos-2_1_2/tos/interfaces/Random.nc"
inline static uint16_t SmacC$Random$rand16(void ){
#line 52
  unsigned short __nesc_result;
#line 52
...
#line 52
# 235 "/home/mehrkavir-lap1/tWorkspace/smac-1.0/src/SmacC.nc"
static inline void SmacC$SendData$fired(void )
#line 235
{
...
#line 240
      rsm = (data_msg_t *)SmacC$Packet$getPayload(&SmacC$packet[sim_node()], sizeof(data_msg_t ));
...
#line 243
        {
          uint8_t randNo = (uint8_t )(SmacC$Random$rand16() % 250);

          __nesc_hton_uint8(rsm->data.nxdata, randNo);
          sim_log_debug(274U, "DebugApp", "\t Send data to My CH(%i). \t@%s\n", SmacC$myCH_ID[sim_node()], sim_time_string());

          if (SmacC$Data_SendMsg$send(SmacC$myCH_ID[sim_node()], &SmacC$packet[sim_node()], sizeof(data_msg_t )) == SUCCESS) {
#line 249
              SmacC$radio_locked[sim_node()] = TRUE;
            }
        }
...
# 75 "/opt/tinyos-2_1_2/tos/interfaces/Send.nc"
inline static error_t /*SmacApp.Aggregate_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$4$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
#line 75
# 162 "/opt/tinyos-2_1_2/tos/interfaces/AMPacket.nc"
inline static void /*SmacApp.Aggregate_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$4$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
  TossimActiveMessageC$AMPacket$setType(amsg, t);
#line 162
}
#line 162
#line 103
inline static void /*SmacApp.Aggregate_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$4$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
  TossimActiveMessageC$AMPacket$setDestination(amsg, addr);
#line 103
}
...
#line 55
{
  /*SmacApp.Aggregate_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$4$AMPacket$setDestination(msg, dest);
  /*SmacApp.Aggregate_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$4$AMPacket$setType(msg, 205);
  return /*SmacApp.Aggregate_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$4$Send$send(msg, len);
}

# 80 "/opt/tinyos-2_1_2/tos/interfaces/AMSend.nc"
inline static error_t SmacC$Aggregate_SendMsg$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*SmacApp.Aggregate_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$4$AMSend$send(addr, msg, len);
#line 80
...
#line 80
# 254 "/home/mehrkavir-lap1/tWorkspace/smac-1.0/src/SmacC.nc"
static inline void SmacC$Aggregate$fired(void )
#line 254
{
  uint8_t data;

  if (SmacC$myState[sim_node()] != 2) {
    return;
    }
  sim_log_debug(275U, "DebugApp", "\t Aggrigate received data. \t@%s\n", sim_time_string());
  if (SmacC$radio_locked[sim_node()]) {
#line 261
      return;
    }
...
#line 264
      rsm = (aggregate_msg_t *)SmacC$Packet$getPayload(&SmacC$packet[sim_node()], sizeof(aggregate_msg_t ));
...
#line 267
        {
          if (SmacC$memberCount_received[sim_node()] == 0) {
            data = 0;
            }
          else {
#line 271
            data = (uint8_t )(SmacC$aggregate_val[sim_node()] / SmacC$memberCount_received[sim_node()]);
            }
          __nesc_hton_uint8(rsm->data.nxdata, data);
          sim_log_debug(276U, "DebugApp", "\t Send aggrigated data(%i) to BaseStation. \t@%s\n", data, sim_time_string());

          if (SmacC$Aggregate_SendMsg$send(BASE_STATION_ADDRESS, &SmacC$packet[sim_node()], sizeof(admission_msg_t )) == SUCCESS) {
#line 276
              SmacC$radio_locked[sim_node()] = TRUE;
            }
        }
...
# 83 "/opt/tinyos-2_1_2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x7ff70c4b5950){
#line 83
  switch (arg_0x7ff70c4b5950) {
#line 83
    case 0U:
#line 83
      MAC_SMAC$gotrts_sleepTimer$fired();
#line 83
      break;
#line 83
    case 1U:
#line 83
      MAC_SMAC$RTSwaitTimer$fired();
#line 83
      break;
#line 83
    case 2U:
#line 83
      MAC_SMAC$CTSwaitTimer$fired();
#line 83
      break;
#line 83
    case 3U:
#line 83
      MAC_SMAC$SYNwaitTimer$fired();
#line 83
      break;
#line 83
    case 4U:
#line 83
      MAC_SMAC$activeTimer$fired();
#line 83
      break;
#line 83
    case 5U:
#line 83
      MAC_SMAC$sleepTimer$fired();
#line 83
      break;
#line 83
    case 6U:
...
#line 83
    case 7U:
#line 83
      SmacC$Appearance$fired();
#line 83
      break;
#line 83
    case 8U:
#line 83
      SmacC$NewCycle$fired();
#line 83
      break;
#line 83
    case 9U:
#line 83
      SmacC$SendData$fired();
#line 83
      break;
#line 83
    case 10U:
#line 83
      SmacC$Aggregate$fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x7ff70c4b5950);
#line 83
      break;
#line 83
    }
...
#line 83
# 181 "/opt/tinyos-2_1_2/tos/lib/tossim/TossimActiveMessageC.nc"
static inline void TossimActiveMessageC$Packet$setPayloadLength(message_t *msg, uint8_t len)
#line 181
{
...
#line 94
# 67 "/opt/tinyos-2_1_2/tos/interfaces/TaskBasic.nc"
inline static error_t MAC_SMAC$startDoneTask$postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP$TaskBasic$postTask(MAC_SMAC$startDoneTask);
#line 67
...
#line 57
  {
    sim_log_debug(287U, "Init", "LEDS: initialized.\n");
...
#line 65
# 142 "/opt/tinyos-2_1_2/tos/lib/tossim/MAC_SMAC.nc"
static inline error_t MAC_SMAC$Init$init(void )
#line 142
{
  ...
  MAC_SMAC$initialized[sim_node()] = TRUE;



  MAC_SMAC$sendEvent[sim_node()].cancelled = 1;
  MAC_SMAC$data_rec2[sim_node()] = (data_packet_t *)malloc(sizeof(data_packet_t ));
  __nesc_hton_uint8(MAC_SMAC$data_rec2[sim_node()]->payload[1].nxdata, 0);
...
# 55 "/opt/tinyos-2_1_2/tos/system/RandomMlcgC.nc"
static inline error_t RandomMlcgC$Init$init(void )
#line 55
{
  /* atomic removed: atomic calls only */
...
#line 62
  __nesc_result = ecombine(__nesc_result, MAC_SMAC$Init$init());
#line 62
...
#line 62
# 73 "/opt/tinyos-2_1_2/tos/lib/timer/Timer.nc"
inline static void SmacC$Appearance$startOneShot(uint32_t dt){
#line 73
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$startOneShot(7U, dt);
#line 73
}
#line 73
# 66 "/home/mehrkavir-lap1/tWorkspace/smac-1.0/src/SmacC.nc"
static inline void SmacC$Boot$booted(void )
#line 66
{
  uint16_t rdm;
...
#line 71
      ...
      SmacC$_timeTick_annonce[sim_node()] = SmacC$_timeTick[sim_node()] + 1;
    }
  else {
      { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
#line 76
...
#line 77
        __nesc_atomic_end(__nesc_atomic); }
      rdm = SmacC$Random$rand16();
      rdm %= 5000 - 0;
      rdm += 3000;

      SmacC$Appearance$startOneShot(rdm);
    }


  sim_log_debug(263U, "DebugApp", "\t Note booted as %s. \t@%s\n", SmacC$myState[sim_node()] == 1 ? "Member" : SmacC$myState[sim_node()] == 2 ? "CH" : SmacC$myState[sim_node()] == 3 ? "BaseStation" : "Unkhown", sim_time_string());
}
...
# 59 "/opt/tinyos-2_1_2/tos/lib/tossim/sim_noise.c"
  void sim_noise_init()
{
  int j;
...
# 76 "/opt/tinyos-2_1_2/tos/lib/tossim/sim_noise.c"
  void sim_noise_create_model(uint16_t node_id)
#line 76
{
...
#line 428
  for (i = 0; i < NOISE_HISTORY; i++) {
      ...
      sim_log_debug(57U, "Insert", "Setting history %i to be %i\n", (int )i, (int )noiseData[node_id].key[i]);
    }
...
#line 290
  ...
  sim_log_debug(24U, "MY_DEBUG", "sim_noise_gen mein bhi ghus gaya hai.\n");
  if (noise_hash == (void *)0) {
  ...
  if (noise_hash->numElements == 1) {
      ...
      sim_log_debug(36U, "MY_DEBUG", "sim_noise_gen se nikal bhi gaya from if1.\n");
      return noise;
    }


  numCase2++;
  sim_log_debug(37U, "Noise_c", "In case 2: %i of %i\n", numCase2, numTotal);


  for (i = 0; i < NOISE_NUM_VALUES - 1; i++) {
      sim_log_debug(38U, "HASH", "IN:for i=%d\n", i);
      if (i == 0) {
...
#line 343
        ...
        ranNum <= noise_hash->dist[i]) {
            noiseIndex = i;
            sim_log_debug_clear(40U, "HASH", "Selected Bin = %d -> ", i + 1);
            break;
          }
        }
    }
#line 350
  sim_log_debug(41U, "HASH", "OUT:for i=%d\n", i);

  noise = NOISE_MIN_QUANTIZE + i;
  sim_log_debug(42U, "NoiseAudit", "Noise: %i\n", noise);
  sim_log_debug(43U, "MY_DEBUG", "sim_noise_gen se nikal bhi gaya.\n");
  return noise;
}
...
# 358 "/opt/tinyos-2_1_2/tos/lib/tossim/sim_noise.c"
  char sim_noise_generate(uint16_t node_id, uint32_t cur_t)
#line 358
{
  uint32_t i;
  ...
  if (noiseData[node_id].generated == 0) {
      sim_log_error(44U, "TOSSIM", "Tried to generate noise from an uninitialized radio model of node %hu.\n", node_id);
      return 127;
    }
  ...
  sim_log_debug(45U, "MY_DEBUG", "MY_DEBUG : sim_noise_generate mein bhi ghus gaya hai.\n");
  if (prev_t == 0) {
...
#line 382
  ...
  sim_log_debug_clear(46U, "HASH", "delta_t = %d\n", delta_t);
  sim_log_debug(47U, "CpmModelC", "sim_noise_generate mein bhi ghus gaya hai.\n");
  if (delta_t == 0) {
      noise = noiseData[node_id].lastNoiseVal;
      sim_log_debug(48U, "CpmModelC", "sim_noise_generate mein bhi ghus gaya hai.\n");
    }
  else {
      ...
      if (noiseG == (void *)0) 
        {
#line 394
          sim_log_debug(49U, "MY_DEBUG", "MY_DEBUG : sim_noise_generate Malloc failed.\n");
          return -80;
        }
      sim_log_debug(50U, "MY_DEBUG", "MY_DEBUG : sim_noise_generate se going to sim_noise_generate hai.\n");
      for (i = 0; i < delta_t; i++) {
          noiseG[i] = sim_noise_gen(node_id);
          sim_log_debug(51U, "MY_DEBUG", "MY_DEBUG : sim_noise_generate mein here 3.\n");
          arrangeKey(node_id);
      ...
      sim_log_debug(52U, "MY_DEBUG", "MY_DEBUG : sim_noise_generate .. going to free this memory.\n");
      free(noiseG);
      sim_log_debug(53U, "MY_DEBUG", "MY_DEBUG : sim_noise_generate .. freed this memory.\n");
    }
  sim_log_debug(54U, "MY_DEBUG", "MY_DEBUG : sim_noise_generate mein here2.\n");
  noiseData[node_id].noiseGenTime = cur_t;
  if (noise == 0) {
      sim_log_debug(55U, "HashZeroDebug", "MY_DEBUG : Generated noise of zero.\n");
    }
  sim_log_debug(56U, "MY_DEBUG", "MY_DEBUG : sim_noise_generate mein here3 noise = %d.\n", noise);
...
#line 102
{
  ...
  sim_log_debug(58U, "Packet", "sim_packet.c: Delivering packet %p to %i at %llu\n", msg, node, t);
...
# 100 "/opt/tinyos-2_1_2/tos/interfaces/Send.nc"
static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0x7ff70c3f82a0, message_t * msg, error_t error){
#line 100
  switch (arg_0x7ff70c3f82a0) {
#line 100
    case 0U:
#line 100
      /*ActiveMessageC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    case 1U:
#line 100
      /*SmacApp.Annonce_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$1$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    case 2U:
#line 100
      /*SmacApp.NewCycle_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$2$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    case 3U:
#line 100
      /*SmacApp.DATA_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$3$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    case 4U:
#line 100
      /*SmacApp.Aggregate_AMS.SenderC.AMQueueEntryP*/AMQueueEntryP$4$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0x7ff70c3f82a0, msg, error);
#line 100
      break;
#line 100
    }
...
#line 100
# 174 "/opt/tinyos-2_1_2/tos/system/AMQueueImplP.nc"
static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$tryToSend(void )
#line 174
{
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$nextPacket();
  if (/*AMQueueP.AMQueueImplP*/AMQueueImplP$0$current[sim_node()] < 5) {
      error_t nextErr;
...
# 78 "/opt/tinyos-2_1_2/tos/interfaces/Packet.nc"
static uint8_t MAC_SMAC$ConPacket$payloadLength(message_t * msg){
#line 78
  unsigned char __nesc_result;
#line 78
...
#line 78
# 958 "/opt/tinyos-2_1_2/tos/lib/tossim/MAC_SMAC.nc"
static void MAC_SMAC$send_data(void )
#line 958
{
...
#line 964
  ...
  MAC_SMAC$sendEvent[sim_node()].mote = sim_node();
  MAC_SMAC$sendEvent[sim_node()].time = first_sample;
  MAC_SMAC$sendEvent[sim_node()].force = 0;
  MAC_SMAC$sendEvent[sim_node()].cancelled = 0;
  MAC_SMAC$sendEvent[sim_node()].handle = MAC_SMAC$send_backoff;
  MAC_SMAC$sendEvent[sim_node()].cleanup = sim_queue_cleanup_none;
  sim_queue_insert(&MAC_SMAC$sendEvent[sim_node()]);
}
...
#line 126
{
  ...
  sim_log_debug(237U, "CpmModelC", "IN: noise_hash_generation()\n");
  ...
  sim_log_debug(238U, "CpmModelC,Tal", "%s: OUT: noise_hash_generation(): %lf\n", sim_time_string(), noise_val);
...
#line 459
{
  ...
  sim_log_debug(262U, "CpmModelC", "setPendingTransmission: transmitting %i @ %s\n", CpmModelC$transmitting[sim_node()], sim_time_string());
}
...
# 499 "/opt/tinyos-2_1_2/tos/lib/tossim/MAC_SMAC.nc"
static error_t MAC_SMAC$Control$stop(void )
#line 499
{
  if (!MAC_SMAC$initialized[sim_node()]) {
      sim_log_error(152U, "TossimPacketModelC", "TossimPacketModelC: Control.stop() called before initialization!\n");
      return FAIL;
    }
  MAC_SMAC$running[sim_node()] = FALSE;
  sim_log_debug(153U, "TossimPacketModelC", "TossimPacketModelC: Control.stop() called.\n");





  MAC_SMAC$stopDoneTask$postTask();
  return SUCCESS;
}
...
# 436 "/opt/tinyos-2_1_2/tos/lib/tossim/CpmModelC.nc"
static void CpmModelC$Model$putOnAirTo(int dest, message_t *msg, bool ack, sim_time_t endTime, double power, double reversePower)
#line 436
{
  CpmModelC$receive_message_t *list;
...
#line 439
  ...
  sim_log_debug(260U, "CpmModelC", "Node %i transmitting to %i, finishes at %llu.\n", sim_node(), dest, endTime);
...
#line 446
  ...
  while (list != (void *)0) {
      list->lost = 1;
      sim_log_debug(261U, "CpmModelC,SNRLoss", "Lost packet from %i because %i has outstanding reception, startTime %llu endTime %llu\n", list->source, sim_node(), list->start, list->end);
      list = list->next;
    }
}
...
# 1099 "/opt/tinyos-2_1_2/tos/lib/tossim/MAC_SMAC.nc"
static bool MAC_SMAC$borderNode_process(void )
#line 1099
{
  ...
  int16_t time_diff = __nesc_ntoh_uint16(MAC_SMAC$syn_rec[sim_node()]->next_sleep_time.nxdata) - (MAC_SMAC$ACTIVE_PERIOD[sim_node()] - (MAC_SMAC$activeTimer$getNow() - MAC_SMAC$activeTimer$gett0()));

#line 1104
  sim_log_debug(184U, "TossimPacketModelC", "TossimPacketModelC: In borderNode_process,  time_diff: %d\n", time_diff);
  if (time_diff < -4 || time_diff > 4) {

      sim_log_debug(185U, "TossimPacketModelC", "TossimPacketModelC: In borderNode_process, I'll follow both schedules. time: %llu\n", sim_time());
      MAC_SMAC$imborderNode[sim_node()] = TRUE;
      if (time_diff > 4) {
          MAC_SMAC$ACTIVE_PERIOD[sim_node()] = __nesc_ntoh_uint16(MAC_SMAC$syn_rec[sim_node()]->next_sleep_time.nxdata);

          MAC_SMAC$SLEEP_PERIOD[sim_node()] = MAC_SMAC$SLEEP_PERIOD[sim_node()] - time_diff;
          MAC_SMAC$activeTimer$startOneShot(MAC_SMAC$ACTIVE_PERIOD[sim_node()]);

          sim_log_debug(186U, "TossimPacketModelC", "TossimPacketModelC: In borderNode_process, extending active period and shortening sleep period. \nACTIVE PERIOD = %hu, SLEEP_PERIOD = %hu time: %llu\n", MAC_SMAC$ACTIVE_PERIOD[sim_node()], MAC_SMAC$SLEEP_PERIOD[sim_node()], sim_time());
        }
      else {

          if (MAC_SMAC$SLEEP_PERIOD[sim_node()] - (__nesc_ntoh_uint16(MAC_SMAC$syn_rec[sim_node()]->sleep_period.nxdata) + time_diff) > 0) {
              MAC_SMAC$SLEEP_PERIOD[sim_node()] = MAC_SMAC$SLEEP_PERIOD[sim_node()] + time_diff;
              sim_log_debug(187U, "TossimPacketModelC", "TossimPacketModelC: In borderNode_process, shortening sleep period. \nACTIVE PERIOD = %hu, SLEEP_PERIOD = %hu time: %llu\n", MAC_SMAC$ACTIVE_PERIOD[sim_node()], MAC_SMAC$SLEEP_PERIOD[sim_node()], sim_time());
            }
          else {
              sim_log_debug(188U, "TossimPacketModelC", "TossimPacketModelC: In borderNode_process, no need to shorten sleep period. \nACTIVE PERIOD = %hu, SLEEP_PERIOD = %hu time: %llu\n", MAC_SMAC$ACTIVE_PERIOD[sim_node()], MAC_SMAC$SLEEP_PERIOD[sim_node()], sim_time());
            }
        }

      return MAC_SMAC$imborderNode[sim_node()];
    }
  else {
      MAC_SMAC$ACTIVE_PERIOD[sim_node()] = __nesc_ntoh_uint16(MAC_SMAC$syn_rec[sim_node()]->next_sleep_time.nxdata);
      MAC_SMAC$activeTimer$startOneShot(MAC_SMAC$ACTIVE_PERIOD[sim_node()]);
...
# 159 "/opt/tinyos-2_1_2/tos/lib/timer/VirtualizeTimerC.nc"
static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$startOneShot(uint8_t num, uint32_t dt)
{
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$startTimer(num, /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$TimerFrom$getNow(), dt, TRUE);
}

# 234 "/opt/tinyos-2_1_2/tos/lib/tossim/MAC_SMAC.nc"
static void MAC_SMAC$start_syn(void )
#line 234
{
  if (!MAC_SMAC$radio_locked[sim_node()]) {
      sim_log_debug(129U, "TossimPacketModelC", "SYNPACKET: here2\n");

      MAC_SMAC$synbackoffCount[sim_node()] = 0;
      MAC_SMAC$syn_table[sim_node()][sim_node()][0] = 150;
      MAC_SMAC$syn_table[sim_node()][sim_node()][1] = 200;
      MAC_SMAC$syn_table[sim_node()][sim_node()][2] = 1;
      MAC_SMAC$isSynchroniser[sim_node()] = TRUE;

      MAC_SMAC$syn[sim_node()] = (SYN_packet_t *)MAC_SMAC$ConPacket$getPayload(&MAC_SMAC$synpacket[sim_node()], 20);

      if (MAC_SMAC$syn[sim_node()] == (void *)0) {
          return;
        }

      __nesc_hton_uint16(MAC_SMAC$syn[sim_node()]->packet_type.nxdata, 1);
      __nesc_hton_int16(MAC_SMAC$syn[sim_node()]->node_id.nxdata, sim_node());
#line 264
      MAC_SMAC$backoff2[sim_node()] = sim_random();
      MAC_SMAC$backoff2[sim_node()] %= sim_csma_init_high() - sim_csma_init_low();
      MAC_SMAC$backoff2[sim_node()] += sim_csma_init_low();
      MAC_SMAC$backoff2[sim_node()] *= sim_ticks_per_sec() / sim_csma_symbols_per_sec();
      sim_log_debug(130U, "TossimPacketModelC", "TossimPacketModelC: Backoff value: %llu\n", MAC_SMAC$backoff2[sim_node()]);
      MAC_SMAC$sample_time[sim_node()] = sim_time() + MAC_SMAC$backoff2[sim_node()] * 10 - 6000000;


      MAC_SMAC$SYNsendEvent[sim_node()].mote = sim_node();
      MAC_SMAC$SYNsendEvent[sim_node()].time = MAC_SMAC$sample_time[sim_node()];
      MAC_SMAC$SYNsendEvent[sim_node()].force = 0;
      MAC_SMAC$SYNsendEvent[sim_node()].cancelled = 0;
      MAC_SMAC$SYNsendEvent[sim_node()].handle = MAC_SMAC$send_syn;
      MAC_SMAC$SYNsendEvent[sim_node()].cleanup = sim_queue_cleanup_none;
      sim_queue_insert(&MAC_SMAC$SYNsendEvent[sim_node()]);
    }
  else 
    {
      sim_log_debug(131U, "TossimPacketModelC", "TossimPacketModelC: Cannot send SYN packet. Radio locked\n");
    }
}
...
{
  if (MAC_SMAC$running[sim_node()] && !MAC_SMAC$transmitting[sim_node()]) {
      return MAC_SMAC$Packet$shouldAck(msg);
    }
  else {
      return FALSE;
    }
...
# 656 "/opt/tinyos-2_1_2/tos/lib/tossim/MAC_SMAC.nc"
static void MAC_SMAC$start_rts(void )
#line 656
{
  MAC_SMAC$backoffCount[sim_node()] = 0;
  MAC_SMAC$rtsbackoffCount[sim_node()] = 0;
  MAC_SMAC$ctsbackoffCount[sim_node()] = 0;
  MAC_SMAC$noRTSCount[sim_node()] = 0;




  MAC_SMAC$metadata2[sim_node()] = MAC_SMAC$getMetadata(MAC_SMAC$sending[sim_node()]);

  MAC_SMAC$duration2[sim_node()] = 8 * (MAC_SMAC$sendingLength[sim_node()] + MAC_SMAC$sim_packet_header_length());
  MAC_SMAC$duration2[sim_node()] /= sim_csma_bits_per_symbol();
  MAC_SMAC$duration2[sim_node()] += sim_csma_preamble_length();

  __nesc_hton_uint8(MAC_SMAC$metadata2[sim_node()]->ack.nxdata, 1);
  if (__nesc_ntoh_uint8(MAC_SMAC$metadata2[sim_node()]->ack.nxdata)) {
      MAC_SMAC$duration2[sim_node()] += sim_csma_ack_time();
    }
  MAC_SMAC$duration2[sim_node()] *= sim_ticks_per_sec() / sim_csma_symbols_per_sec();


  MAC_SMAC$rts[sim_node()] = (RTS_packet_t *)MAC_SMAC$ConPacket$getPayload(&MAC_SMAC$rtspacket[sim_node()], 20);
  __nesc_hton_uint16(MAC_SMAC$rts[sim_node()]->packet_type.nxdata, 2);
  __nesc_hton_int16(MAC_SMAC$rts[sim_node()]->src_id.nxdata, sim_node());
  __nesc_hton_int16(MAC_SMAC$rts[sim_node()]->dest_id.nxdata, MAC_SMAC$destNode[sim_node()]);
  __nesc_hton_uint16(MAC_SMAC$rts[sim_node()]->duration.nxdata, MAC_SMAC$duration2[sim_node()]);
...
#line 700
{
  if (MAC_SMAC$syn_done[sim_node()]) {

      sim_log_debug(159U, "TossimPacketModelC", "Trying to send RTS. noRTSCount=%hu Time = %llu\n", MAC_SMAC$noRTSCount[sim_node()], sim_time());
      if (MAC_SMAC$running[sim_node()]) {
          MAC_SMAC$rtsbackoffCount[sim_node()]++;
          sim_log_debug(160U, "TossimPacketModelC", "Trying to send RTS. noRTSCount=%hu Time = %llu\n", MAC_SMAC$noRTSCount[sim_node()], sim_time());
          if (MAC_SMAC$GainRadioModel$clearChannel()) {
              sim_time_t delay;
...
#line 709
              ...
              MAC_SMAC$transmitting[sim_node()] = TRUE;
              MAC_SMAC$GainRadioModel$setPendingTransmission();
              evt->handle = MAC_SMAC$send_transmit_rts;
              ...
              if (MAC_SMAC$rtsbackoffCount[sim_node()] <= 20) {
                  MAC_SMAC$backoff2[sim_node()] = sim_random();
                  MAC_SMAC$backoff2[sim_node()] %= sim_csma_init_high() - sim_csma_init_low();
                  MAC_SMAC$backoff2[sim_node()] += sim_csma_init_low();
                  MAC_SMAC$backoff2[sim_node()] *= sim_ticks_per_sec() / sim_csma_symbols_per_sec();
...
#line 735
                      MAC_SMAC$sending[sim_node()] = (void *)0;
                      sim_log_debug(161U, "TossimPacketModelC", "PACKET: Failed to send RTS no %hu packet due to busy channel.\n", MAC_SMAC$totalRTSCount[sim_node()]);
                      MAC_SMAC$radio_locked[sim_node()] = FALSE;
          ...
          if (!MAC_SMAC$activeTimer$isRunning()) {
#line 765
              uint16_t next_wakeup_time = MAC_SMAC$SLEEP_PERIOD[sim_node()] - (MAC_SMAC$sleepTimer$getNow() - MAC_SMAC$sleepTimer$gett0());
              sim_time_t temp = next_wakeup_time;

#line 767
              if (temp > MAC_SMAC$SLEEP_PERIOD[sim_node()]) {
                temp = MAC_SMAC$SLEEP_PERIOD[sim_node()];
                }
              sim_log_debug(162U, "TossimPacketModelC", "In send_rts(), radio sleeping.\n", MAC_SMAC$totalRTSCount[sim_node()]);
              MAC_SMAC$backoff2[sim_node()] = sim_random();
              MAC_SMAC$backoff2[sim_node()] %= sim_csma_init_high() - sim_csma_init_low();
              MAC_SMAC$backoff2[sim_node()] += sim_csma_init_low();
              MAC_SMAC$backoff2[sim_node()] *= sim_ticks_per_sec() / sim_csma_symbols_per_sec();

              evt->time = sim_time() + MAC_SMAC$backoff2[sim_node()] + temp * 10000000;
              sim_queue_insert(evt);
              sim_log_debug(163U, "TossimPacketModelC", "Postponed RTS to next wakeUp Time event will fire at time = %llu. temp = %llu Current Time = %llu\n", evt->time, temp, sim_time());
            }
        }
    }
  else {
#line 798
      uint16_t time_left = 100 - (MAC_SMAC$SYNwaitTimer$getNow() - MAC_SMAC$SYNwaitTimer$gett0());
      sim_time_t syn_sending_time = time_left;

#line 800
      if (syn_sending_time > 100) {
        syn_sending_time = 100;
        }
      sim_log_debug(164U, "TossimPacketModelC", "Postponing RTS to after Synchro period. time_left = %hu, syn_sending_time=%llu Time = %llu\n", time_left, syn_sending_time, sim_time());
      MAC_SMAC$backoff2[sim_node()] = sim_random();
      MAC_SMAC$backoff2[sim_node()] %= sim_csma_init_high() - sim_csma_init_low();
      MAC_SMAC$backoff2[sim_node()] += sim_csma_init_low();
      MAC_SMAC$backoff2[sim_node()] *= sim_ticks_per_sec() / sim_csma_symbols_per_sec();

      evt->time = sim_time() + MAC_SMAC$backoff2[sim_node()] + syn_sending_time * 10000000;
      sim_log_debug(165U, "TossimPacketModelC", "RTS will be sent at Time = %llu\n", evt->time);
      sim_queue_insert(evt);
    }
}
...
# 69 "/opt/tinyos-2_1_2/tos/system/RandomMlcgC.nc"
static uint32_t RandomMlcgC$Random$rand32(void )
#line 69
{
  uint32_t mlcg;
...
# 479 "/opt/tinyos-2_1_2/tos/lib/tossim/MAC_SMAC.nc"
static error_t MAC_SMAC$Control$start(void )
#line 479
{
  if (!MAC_SMAC$initialized[sim_node()]) {
  ...
  MAC_SMAC$startDoneTask$postTask();
  MAC_SMAC$running[sim_node()] = TRUE;
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  /* Module MAC_SMAC */
  if (!strcmp(varname, "MAC_SMAC$initialized"))
  {
    *addr = (uintptr_t)&MAC_SMAC$initialized[__nesc_mote];
    *size = sizeof(MAC_SMAC$initialized[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "MAC_SMAC$running"))
  {
    *addr = (uintptr_t)&MAC_SMAC$running[__nesc_mote];
    *size = sizeof(MAC_SMAC$running[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "MAC_SMAC$backoffCount"))
  {
    *addr = (uintptr_t)&MAC_SMAC$backoffCount[__nesc_mote];
    *size = sizeof(MAC_SMAC$backoffCount[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "MAC_SMAC$synbackoffCount"))
  {
    *addr = (uintptr_t)&MAC_SMAC$synbackoffCount[__nesc_mote];
    *size = sizeof(MAC_SMAC$synbackoffCount[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "MAC_SMAC$rtsbackoffCount"))
  {
    *addr = (uintptr_t)&MAC_SMAC$rtsbackoffCount[__nesc_mote];
    *size = sizeof(MAC_SMAC$rtsbackoffCount[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "MAC_SMAC$ctsbackoffCount"))
  {
    *addr = (uintptr_t)&MAC_SMAC$ctsbackoffCount[__nesc_mote];
    *size = sizeof(MAC_SMAC$ctsbackoffCount[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "MAC_SMAC$noRTSCount"))
  {
    *addr = (uintptr_t)&MAC_SMAC$noRTSCount[__nesc_mote];
    *size = sizeof(MAC_SMAC$noRTSCount[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "MAC_SMAC$totalRTSCount"))
  {
    *addr = (uintptr_t)&MAC_SMAC$totalRTSCount[__nesc_mote];
    *size = sizeof(MAC_SMAC$totalRTSCount[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "MAC_SMAC$noSYN_rec"))
  {
    *addr = (uintptr_t)&MAC_SMAC$noSYN_rec[__nesc_mote];
    *size = sizeof(MAC_SMAC$noSYN_rec[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "MAC_SMAC$no_SendTry"))
  {
    *addr = (uintptr_t)&MAC_SMAC$no_SendTry[__nesc_mote];
    *size = sizeof(MAC_SMAC$no_SendTry[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "MAC_SMAC$sending"))
  {
    *addr = (uintptr_t)&MAC_SMAC$sending[__nesc_mote];
    *size = sizeof(MAC_SMAC$sending[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "MAC_SMAC$transmitting"))
  {
    *addr = (uintptr_t)&MAC_SMAC$transmitting[__nesc_mote];
    *size = sizeof(MAC_SMAC$transmitting[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "MAC_SMAC$sendingLength"))
  {
    *addr = (uintptr_t)&MAC_SMAC$sendingLength[__nesc_mote];
    *size = sizeof(MAC_SMAC$sendingLength[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "MAC_SMAC$destNode"))
  {
    *addr = (uintptr_t)&MAC_SMAC$destNode[__nesc_mote];
    *size = sizeof(MAC_SMAC$destNode[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "MAC_SMAC$radio_locked"))
  {
    *addr = (uintptr_t)&MAC_SMAC$radio_locked[__nesc_mote];
    *size = sizeof(MAC_SMAC$radio_locked[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "MAC_SMAC$syn_done"))
  {
    *addr = (uintptr_t)&MAC_SMAC$syn_done[__nesc_mote];
    *size = sizeof(MAC_SMAC$syn_done[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "MAC_SMAC$syn_sentbyme"))
  {
    *addr = (uintptr_t)&MAC_SMAC$syn_sentbyme[__nesc_mote];
    *size = sizeof(MAC_SMAC$syn_sentbyme[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "MAC_SMAC$radioOnbyTimer"))
  {
    *addr = (uintptr_t)&MAC_SMAC$radioOnbyTimer[__nesc_mote];
    *size = sizeof(MAC_SMAC$radioOnbyTimer[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "MAC_SMAC$imborderNode"))
  {
    *addr = (uintptr_t)&MAC_SMAC$imborderNode[__nesc_mote];
    *size = sizeof(MAC_SMAC$imborderNode[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "MAC_SMAC$alreadyTryingforSYNC"))
  {
    *addr = (uintptr_t)&MAC_SMAC$alreadyTryingforSYNC[__nesc_mote];
    *size = sizeof(MAC_SMAC$alreadyTryingforSYNC[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "MAC_SMAC$waiting_fordata"))
  {
    *addr = (uintptr_t)&MAC_SMAC$waiting_fordata[__nesc_mote];
    *size = sizeof(MAC_SMAC$waiting_fordata[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "MAC_SMAC$SLEEP_PERIOD"))
  {
    *addr = (uintptr_t)&MAC_SMAC$SLEEP_PERIOD[__nesc_mote];
    *size = sizeof(MAC_SMAC$SLEEP_PERIOD[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "MAC_SMAC$ACTIVE_PERIOD"))
  {
    *addr = (uintptr_t)&MAC_SMAC$ACTIVE_PERIOD[__nesc_mote];
    *size = sizeof(MAC_SMAC$ACTIVE_PERIOD[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "MAC_SMAC$syn"))
  {
    *addr = (uintptr_t)&MAC_SMAC$syn[__nesc_mote];
    *size = sizeof(MAC_SMAC$syn[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "MAC_SMAC$rts"))
  {
    *addr = (uintptr_t)&MAC_SMAC$rts[__nesc_mote];
    *size = sizeof(MAC_SMAC$rts[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "MAC_SMAC$cts"))
  {
    *addr = (uintptr_t)&MAC_SMAC$cts[__nesc_mote];
    *size = sizeof(MAC_SMAC$cts[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "MAC_SMAC$data_packet"))
  {
    *addr = (uintptr_t)&MAC_SMAC$data_packet[__nesc_mote];
    *size = sizeof(MAC_SMAC$data_packet[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "MAC_SMAC$data_packet2"))
  {
    *addr = (uintptr_t)&MAC_SMAC$data_packet2[__nesc_mote];
    *size = sizeof(MAC_SMAC$data_packet2[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "MAC_SMAC$data_rec2"))
  {
    *addr = (uintptr_t)&MAC_SMAC$data_rec2[__nesc_mote];
    *size = sizeof(MAC_SMAC$data_rec2[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "MAC_SMAC$syn_table"))
  {
    *addr = (uintptr_t)&MAC_SMAC$syn_table[__nesc_mote];
    *size = sizeof(MAC_SMAC$syn_table[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "MAC_SMAC$isSynchroniser"))
  {
    *addr = (uintptr_t)&MAC_SMAC$isSynchroniser[__nesc_mote];
    *size = sizeof(MAC_SMAC$isSynchroniser[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "MAC_SMAC$isFollower"))
  {
    *addr = (uintptr_t)&MAC_SMAC$isFollower[__nesc_mote];
    *size = sizeof(MAC_SMAC$isFollower[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "MAC_SMAC$synpacket"))
  {
    *addr = (uintptr_t)&MAC_SMAC$synpacket[__nesc_mote];
    *size = sizeof(MAC_SMAC$synpacket[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "MAC_SMAC$rtspacket"))
  {
    *addr = (uintptr_t)&MAC_SMAC$rtspacket[__nesc_mote];
    *size = sizeof(MAC_SMAC$rtspacket[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "MAC_SMAC$ctspacket"))
  {
    *addr = (uintptr_t)&MAC_SMAC$ctspacket[__nesc_mote];
    *size = sizeof(MAC_SMAC$ctspacket[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "MAC_SMAC$sendEvent"))
  {
    *addr = (uintptr_t)&MAC_SMAC$sendEvent[__nesc_mote];
    *size = sizeof(MAC_SMAC$sendEvent[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "MAC_SMAC$SYNsendEvent"))
  {
    *addr = (uintptr_t)&MAC_SMAC$SYNsendEvent[__nesc_mote];
    *size = sizeof(MAC_SMAC$SYNsendEvent[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "MAC_SMAC$RTSsendEvent"))
  {
    *addr = (uintptr_t)&MAC_SMAC$RTSsendEvent[__nesc_mote];
    *size = sizeof(MAC_SMAC$RTSsendEvent[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "MAC_SMAC$CTSsendEvent"))
  {
    *addr = (uintptr_t)&MAC_SMAC$CTSsendEvent[__nesc_mote];
    *size = sizeof(MAC_SMAC$CTSsendEvent[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "MAC_SMAC$sample_time"))
  {
    *addr = (uintptr_t)&MAC_SMAC$sample_time[__nesc_mote];
    *size = sizeof(MAC_SMAC$sample_time[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "MAC_SMAC$backoff2"))
  {
    *addr = (uintptr_t)&MAC_SMAC$backoff2[__nesc_mote];
    *size = sizeof(MAC_SMAC$backoff2[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "MAC_SMAC$metadata2"))
  {
    *addr = (uintptr_t)&MAC_SMAC$metadata2[__nesc_mote];
    *size = sizeof(MAC_SMAC$metadata2[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "MAC_SMAC$duration2"))
  {
    *addr = (uintptr_t)&MAC_SMAC$duration2[__nesc_mote];
    *size = sizeof(MAC_SMAC$duration2[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "MAC_SMAC$rts"))
  {
  ...
  if (!strcmp(varname, "MAC_SMAC$syn3"))
  {
    *addr = (uintptr_t)&MAC_SMAC$syn3[__nesc_mote];
    *size = sizeof(MAC_SMAC$syn3[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "MAC_SMAC$syn_rec"))
  {
    *addr = (uintptr_t)&MAC_SMAC$syn_rec[__nesc_mote];
    *size = sizeof(MAC_SMAC$syn_rec[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "MAC_SMAC$rts_rec"))
  {
    *addr = (uintptr_t)&MAC_SMAC$rts_rec[__nesc_mote];
    *size = sizeof(MAC_SMAC$rts_rec[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "MAC_SMAC$cts_rec"))
  {
    *addr = (uintptr_t)&MAC_SMAC$cts_rec[__nesc_mote];
    *size = sizeof(MAC_SMAC$cts_rec[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "MAC_SMAC$data_rec"))
  {
    *addr = (uintptr_t)&MAC_SMAC$data_rec[__nesc_mote];
    *size = sizeof(MAC_SMAC$data_rec[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "MAC_SMAC$error"))
  {
    *addr = (uintptr_t)&MAC_SMAC$error[__nesc_mote];
    *size = sizeof(MAC_SMAC$error[__nesc_mote]);
    return 0;
  }
  ...
  /* Module SmacC */
  if (!strcmp(varname, "SmacC$packet"))
  {
    *addr = (uintptr_t)&SmacC$packet[__nesc_mote];
    *size = sizeof(SmacC$packet[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SmacC$_timeTick"))
  {
    *addr = (uintptr_t)&SmacC$_timeTick[__nesc_mote];
    *size = sizeof(SmacC$_timeTick[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SmacC$_timeTick_annonce"))
  {
    *addr = (uintptr_t)&SmacC$_timeTick_annonce[__nesc_mote];
    *size = sizeof(SmacC$_timeTick_annonce[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SmacC$_timeTick_newCycle"))
  {
    *addr = (uintptr_t)&SmacC$_timeTick_newCycle[__nesc_mote];
    *size = sizeof(SmacC$_timeTick_newCycle[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SmacC$_timeTick_aggregate"))
  {
    *addr = (uintptr_t)&SmacC$_timeTick_aggregate[__nesc_mote];
    *size = sizeof(SmacC$_timeTick_aggregate[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SmacC$_timeTick_data"))
  {
    *addr = (uintptr_t)&SmacC$_timeTick_data[__nesc_mote];
    *size = sizeof(SmacC$_timeTick_data[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SmacC$radio_locked"))
  {
    *addr = (uintptr_t)&SmacC$radio_locked[__nesc_mote];
    *size = sizeof(SmacC$radio_locked[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SmacC$isAppearance"))
  {
    *addr = (uintptr_t)&SmacC$isAppearance[__nesc_mote];
    *size = sizeof(SmacC$isAppearance[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SmacC$seeBaseStation"))
  {
    *addr = (uintptr_t)&SmacC$seeBaseStation[__nesc_mote];
    *size = sizeof(SmacC$seeBaseStation[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SmacC$hasCH"))
  {
    *addr = (uintptr_t)&SmacC$hasCH[__nesc_mote];
    *size = sizeof(SmacC$hasCH[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SmacC$myState"))
  {
    *addr = (uintptr_t)&SmacC$myState[__nesc_mote];
    *size = sizeof(SmacC$myState[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SmacC$myCH_ID"))
  {
    *addr = (uintptr_t)&SmacC$myCH_ID[__nesc_mote];
    *size = sizeof(SmacC$myCH_ID[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SmacC$memberCount_received"))
  {
    *addr = (uintptr_t)&SmacC$memberCount_received[__nesc_mote];
    *size = sizeof(SmacC$memberCount_received[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SmacC$aggregate_val"))
  {
    *addr = (uintptr_t)&SmacC$aggregate_val[__nesc_mote];
    *size = sizeof(SmacC$aggregate_val[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SmacC$macIsActive"))
  {
    *addr = (uintptr_t)&SmacC$macIsActive[__nesc_mote];
    *size = sizeof(SmacC$macIsActive[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  /* Module MAC_SMAC */
  MAC_SMAC$initialized[__nesc_mote] = FALSE;
  MAC_SMAC$running[__nesc_mote] = FALSE;
  memset((void *)&MAC_SMAC$backoffCount[__nesc_mote], 0, sizeof MAC_SMAC$backoffCount[__nesc_mote]);
  memset((void *)&MAC_SMAC$synbackoffCount[__nesc_mote], 0, sizeof MAC_SMAC$synbackoffCount[__nesc_mote]);
  memset((void *)&MAC_SMAC$rtsbackoffCount[__nesc_mote], 0, sizeof MAC_SMAC$rtsbackoffCount[__nesc_mote]);
  memset((void *)&MAC_SMAC$ctsbackoffCount[__nesc_mote], 0, sizeof MAC_SMAC$ctsbackoffCount[__nesc_mote]);
  memset((void *)&MAC_SMAC$noRTSCount[__nesc_mote], 0, sizeof MAC_SMAC$noRTSCount[__nesc_mote]);
  MAC_SMAC$totalRTSCount[__nesc_mote] = 0;
  MAC_SMAC$noSYN_rec[__nesc_mote] = 0;
  MAC_SMAC$no_SendTry[__nesc_mote] = 0;
  MAC_SMAC$sending[__nesc_mote] = (void *)0;
  MAC_SMAC$transmitting[__nesc_mote] = FALSE;
  MAC_SMAC$sendingLength[__nesc_mote] = 0;
  memset((void *)&MAC_SMAC$destNode[__nesc_mote], 0, sizeof MAC_SMAC$destNode[__nesc_mote]);
  MAC_SMAC$radio_locked[__nesc_mote] = FALSE;
  MAC_SMAC$syn_done[__nesc_mote] = FALSE;
  MAC_SMAC$syn_sentbyme[__nesc_mote] = FALSE;
  MAC_SMAC$radioOnbyTimer[__nesc_mote] = TRUE;
  MAC_SMAC$imborderNode[__nesc_mote] = FALSE;
  MAC_SMAC$alreadyTryingforSYNC[__nesc_mote] = FALSE;
  MAC_SMAC$waiting_fordata[__nesc_mote] = FALSE;
  MAC_SMAC$SLEEP_PERIOD[__nesc_mote] = 600;
  MAC_SMAC$ACTIVE_PERIOD[__nesc_mote] = 400;
  MAC_SMAC$syn[__nesc_mote] = (void *)0;
  memset((void *)&MAC_SMAC$rts[__nesc_mote], 0, sizeof MAC_SMAC$rts[__nesc_mote]);
  memset((void *)&MAC_SMAC$cts[__nesc_mote], 0, sizeof MAC_SMAC$cts[__nesc_mote]);
  memset((void *)&MAC_SMAC$data_packet[__nesc_mote], 0, sizeof MAC_SMAC$data_packet[__nesc_mote]);
  memset((void *)&MAC_SMAC$data_packet2[__nesc_mote], 0, sizeof MAC_SMAC$data_packet2[__nesc_mote]);
  memset((void *)&MAC_SMAC$data_rec2[__nesc_mote], 0, sizeof MAC_SMAC$data_rec2[__nesc_mote]);
  memset((void *)&MAC_SMAC$syn_table[__nesc_mote], 0, sizeof MAC_SMAC$syn_table[__nesc_mote]);
  MAC_SMAC$isSynchroniser[__nesc_mote] = FALSE;
  MAC_SMAC$isFollower[__nesc_mote] = FALSE;
  memset((void *)&MAC_SMAC$synpacket[__nesc_mote], 0, sizeof MAC_SMAC$synpacket[__nesc_mote]);
  memset((void *)&MAC_SMAC$rtspacket[__nesc_mote], 0, sizeof MAC_SMAC$rtspacket[__nesc_mote]);
  memset((void *)&MAC_SMAC$ctspacket[__nesc_mote], 0, sizeof MAC_SMAC$ctspacket[__nesc_mote]);
  memset((void *)&MAC_SMAC$sendEvent[__nesc_mote], 0, sizeof MAC_SMAC$sendEvent[__nesc_mote]);
  memset((void *)&MAC_SMAC$SYNsendEvent[__nesc_mote], 0, sizeof MAC_SMAC$SYNsendEvent[__nesc_mote]);
  memset((void *)&MAC_SMAC$RTSsendEvent[__nesc_mote], 0, sizeof MAC_SMAC$RTSsendEvent[__nesc_mote]);
  memset((void *)&MAC_SMAC$CTSsendEvent[__nesc_mote], 0, sizeof MAC_SMAC$CTSsendEvent[__nesc_mote]);
  memset((void *)&MAC_SMAC$sample_time[__nesc_mote], 0, sizeof MAC_SMAC$sample_time[__nesc_mote]);
  memset((void *)&MAC_SMAC$backoff2[__nesc_mote], 0, sizeof MAC_SMAC$backoff2[__nesc_mote]);
  memset((void *)&MAC_SMAC$metadata2[__nesc_mote], 0, sizeof MAC_SMAC$metadata2[__nesc_mote]);
  memset((void *)&MAC_SMAC$duration2[__nesc_mote], 0, sizeof MAC_SMAC$duration2[__nesc_mote]);
  MAC_SMAC$rts[__nesc_mote] = (void *)0;
  memset((void *)&MAC_SMAC$syn3[__nesc_mote], 0, sizeof MAC_SMAC$syn3[__nesc_mote]);
  memset((void *)&MAC_SMAC$syn_rec[__nesc_mote], 0, sizeof MAC_SMAC$syn_rec[__nesc_mote]);
  memset((void *)&MAC_SMAC$rts_rec[__nesc_mote], 0, sizeof MAC_SMAC$rts_rec[__nesc_mote]);
  memset((void *)&MAC_SMAC$cts_rec[__nesc_mote], 0, sizeof MAC_SMAC$cts_rec[__nesc_mote]);
  memset((void *)&MAC_SMAC$data_rec[__nesc_mote], 0, sizeof MAC_SMAC$data_rec[__nesc_mote]);
  MAC_SMAC$error[__nesc_mote] = 0;
  ...
  /* Module AMQueueImplP$0 */
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$current[__nesc_mote] = 5;
  ...
  /* Module SmacC */
  memset((void *)&SmacC$packet[__nesc_mote], 0, sizeof SmacC$packet[__nesc_mote]);
  SmacC$_timeTick[__nesc_mote] = 1;
  SmacC$_timeTick_annonce[__nesc_mote] = 0;
  SmacC$_timeTick_newCycle[__nesc_mote] = 0;
  SmacC$_timeTick_aggregate[__nesc_mote] = 0;
  SmacC$_timeTick_data[__nesc_mote] = 0;
  SmacC$radio_locked[__nesc_mote] = FALSE;
  SmacC$isAppearance[__nesc_mote] = FALSE;
  SmacC$seeBaseStation[__nesc_mote] = FALSE;
  SmacC$hasCH[__nesc_mote] = FALSE;
  SmacC$myState[__nesc_mote] = 0;
  memset((void *)&SmacC$myCH_ID[__nesc_mote], 0, sizeof SmacC$myCH_ID[__nesc_mote]);
  SmacC$memberCount_received[__nesc_mote] = 0;
  memset((void *)&SmacC$aggregate_val[__nesc_mote], 0, sizeof SmacC$aggregate_val[__nesc_mote]);
  SmacC$macIsActive[__nesc_mote] = FALSE;
